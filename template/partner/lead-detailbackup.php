                                    ...
                                    <div class="form-row">
                                        <div class="col-md-12">
                                            <div class="form-group ml-3 mr-3">
                                                ...
                                                <input type="text" class="form-control placement text-size" name="leads_id" id="leads_id" value="<?= $data->leads_id ?>" <?= $cabang_asal == $data->cabang_cross ? 'readonly' : '' ?> required placeholder="202001SLOS12345" maxlength="15">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-row">
