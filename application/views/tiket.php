    ...
    <div class="col-12">
        <div class="card m-b-20">
            <div class="card-body">
                ...
                <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive wrap text-size"
                        ...
                        <tr>
                            ...
                            <td>
                                <center>
                                    ...
                                    <a href="<?= base_url('Agent/detail/' . $ticket->agent_id) ?>"
                                        class="btn btn-primary text-size">Detail</a>
                                    <?php } else if ($ticket->partner_id != NULL) { ?>
                                    <a href="<?= base_url('partner/detail/' . $ticket->partner_id) ?>"
                                        class="btn btn-primary text-size">Detail</a>
                                    <?php } else if ($ticket->id_leads != NULL) { ?>
                                    <a href="<?= base_url('leads/detail/' . $ticket->id_leads) ?>"
                                        class="btn btn-primary text-size">Detail</a>
                                    <?php } else if ($ticket->id_nst != NULL) { ?>
                                    <a href="<?= base_url('nst/edit/' . $ticket->id_nst) ?>"
                                        class="btn btn-primary text-size">Detail</a>
                                    <?php } else if ($ticket->id_approval_bonus != NULL) { ?>
                                    <a href="<?= base_url('approval_bonus/edit/' . $ticket->id_approval_bonus) ?>"
                                        class="btn btn-primary text-size">Detail</a>
                                    <?php } ?>
