            ...
            <div class="card-body">
                <form action="<?= base_url('Leads/update') ?>" method="post" enctype="multipart/form-data"
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="input-group-append">
                                                    ...
                                                    <button class="btn btn-primary text-size" type="button"
                                                        ...
                                                        data-target="#modal-leads"><b>Cari</b></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group text-size fomr-right">
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="jenis_kelamin" id=""
                                                    required <?= $data->jenis_kelamin == 'Perempuan' ? 'checked' : '' ?>
                                                    value="Perempuan">
                                                <label class="form-check-label">
                                                    Perempuan
                                                </label>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group form-right">
                                            ...
                                            <input type="text" class="form-control text-size placement number-only"
                                                name="" id="" value="" required placeholder="0896 5533 985"
                                                maxlength="15" />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-row">
                                    ...
                                    <div class="form-margin">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control text-size readonly pointer"
                                                name="nama_agent" id="nama_agent" placeholder=""
                                                value="<?= $data->nama_agent ?>" aria-label="Recipient's username"
                                                aria-describedby="button-addon2">
                                            <div class="input-group-append">
                                                <button class="btn btn-light btn-data text-size" type="button"
                                ...
                                <div class="col-md-12 form">
                                    <div class="form-margin">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control text-size readonly pointer"
                                                name="nama_partner" id="nama_partner" value="<?= $data->nama_partner ?>"
                    ...
                    <div class="form-group mb-0 float-right mt-5 form-margin">
                        <button class="btn btn-light waves-effect waves-light btn-cari text-size btn-width" id="draft"
