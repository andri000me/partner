                    ...
                    <div class="row">
                            ...
                            <div class="form-row">
                                <div class="col-md-12">
                                    <div class="form-group ml-3 mr-3">
                                        <label>Cabang</label>
                                        <input type="text" class="form-control text-size" name="nama_cabang" id="nama_cabang" placeholder="Cabang" readonly>
                            ...
                            <div class="form-row">
                                <div class="col-md-12">
                                    <div class="form-group ml-3 mr-3">
                                        ...
                                        <input type="text" class="form-control text-size" name="konsumen" id="nama_requester" placeholder="Requester" value="<?= set_value('requester') ?>" readonly>
                            ...
                            <div class="form-row">
                                <div class="col-md-12">
                                    <div class="form-group ml-3 mr-3">
                                        ...
                                        <input type="text" class="form-control text-size" name="tanggal" id="tanggal" placeholder="Tanggal Dibuat" value="<?= set_value('date') ?>" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                            ...
                            <div class="form-row">
                                <div class="col-md-12">
                                    <div class="form-group ml-3 mr-3">
                                        ...
                                        <input type="text" class="form-control text-size" name="soa" id="soa" placeholder="Sumber Lead" value="<?= set_value('soa') ?>" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group ml-3 mr-3">
                                ...
                                <input type="text" class="form-control text-size placement number-only" name="no_kontrak" id="no_kontrak" value="<?= set_value('no_kontrak') ?>" required placeholder="Nomor Kontrak" minlength="10" maxlength="10" />
                            </div>
                            <div class="form-group ml-3 mr-3">
