                     ...
                     <div class="row">
                         ...
                         <div class="col-md-6">
                             ...
                             <div class="form-group ml-4 mr-4">
                                 ...
                                 <input type="text" class="form-control text-size placement number-only" name="nomor_rekening" id="nomor_rekening" value="<?= set_value('nomor_rekening') ?>" required placeholder="Nomor Rekening" minlength="7" maxlength="50" />
                             </div>
                             <div class="form-group ml-4 mr-4">
