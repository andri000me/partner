                ...
                <div class="directory-bg text-center" style="background-image: url(../assets/images/montain.jpeg);">
                    <div class="directory-overlay">
                        <a class="image-popup-vertical-fit" href="../assets/images/ibrahim.jpeg" title="Foto Profile.">
                            <img class="img-fluid rounded-circle" alt="" src="../assets/images/ibrahim.jpeg" style="width: 200px; height: 200px;">
                        </a>
                    </div>
                </div>

                <div class="directory-content text-center p-4">
                    <p class=" mt-4">Jabatan, Cabang</p>
                    <h4 class="font-16">Ibrahim Ahmad Jabar #NIK</h4>
                ...
                <form action="">
                    <div class="form-row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group ml-3 mr-3">
                                <label>Cabang</label>
                                <input type="text" class="form-control" name="cabang" id="cabang" required placeholder="">
                            </div>
                        </div>
                    </div>
                    <div class="form-row">
