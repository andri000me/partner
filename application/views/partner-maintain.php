    ...
    <div class="col-lg-8">
        <div class="page-title-box">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?= base_url('partner') ?>">Merchant</a></li>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted m-b-30 text-size">Form ini digunakan untuk mencatat aktivitas maintain cabang anda.
                </p>

                <form class="" action="<?= base_url('Maintain_partner/save') ?>" method="post"
                    ...
                    <div class="form-group text-size ml-3 mr-3">
                        ...
                        <input type="file" name="photo_activity" class="filestyle text-size"
                            data-buttonname="btn-secondary text-size" required>
                    </div>
                    ...
                    <div class="form-group ml-3 mr-3 text-size">
                        ...
                        <textarea class="form-control text-size" name="catatan" id="catatan" cols="30" rows="10"
                            placeholder="jelaskan detail kegiatan anda" style="height:110px;"></textarea>
                    </div>
