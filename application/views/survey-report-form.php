                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="form-group form-left">
                                        ...
                                        <input type="text" class="form-control text-size" value="<?= $leads->nama_konsumen ?>" name="nama_konsumen" id="nama_konsumen" disabled />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group form-right">
                                        <label>Nomor KTP</label>
                                        <input type="phone" class="form-control text-size placement number-only" value="<?= $leads->no_ktp ?>" disabled name="no_ktp" id="no_ktp" minlength="16" maxlength="16" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-md-4">
                                    <div class="form-group form-left">
                                        ...
                                        <input type="text" class="form-control text-size placement number-only" value="<?= $leads->telepon ?>" disabled name="telepon" id="telepon" maxlength="15" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group form-center">
                                        <label>Nomor WA</label>
                                        <input type="text" class="form-control text-size placement number-only" value="" disabled name="" id="" maxlength="15" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div id="hide" class="form-group form-right">
                                        <label>Pilih Cabang Tujuan</label>
                                        <select class="form-control text-size" name="cabang_cross" disabled id="cabang_cross">
                            ...
                            <div class="form-row">
                                <div class="col-md-4">
                                    <div class="form-group text-size form-left">
                                        ...
                                        <div class="form-check form-check-inline mt-2">
                                            <input class="form-check-input" type="radio" name="jenis_kelamin" <?= $leads->jenis_kelamin == 'Laki - Laki' ? 'checked' : '' ?> disabled id="" value="Laki - Laki">
                                            <label class="form-check-label">
                                                Laki - Laki
                                            </label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="jenis_kelamin" <?= $leads->jenis_kelamin == 'Perempuan' ? 'checked' : '' ?> disabled id="" value="Perempuan">
                                            <label class="form-check-label">
                                                Perempuan
                                            </label>
                                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group form-center">
                                        ...
                                        <select class="form-control text-size" name="status_konsumen" disabled id="status_konsumen">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group form-right">
                                        ...
                                        <select class="form-control text-size" name="soa" id="soa" disabled>
                                            <option selected value="">
                                            </option>
                            ...
                            <div class="collapse" id="konsumen">
                                <div class="form-row">
                                    <div class="col-md-4">
                                        <div class="form-group form-left">
                                            <label>Email</label>
                                            <input type="email" class="form-control text-size" name="email" value="<?= $leads->email ?>" disabled id="email">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group form-center">
                                            <label>Tanggal Lahir</label>
                                            <input type="date" class="form-control text-size" name="tanggal_lahir" id="tanggal_lahir" value="<?= $leads->tanggal_lahir ?>" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group form-right">
                                            <label>Pendidikan</label>
                                            <select class="form-control text-size" name="pendidikan" id="pendidikan" disabled>
                                                <option selected value="">
                                                </option>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group form-center">
                                            ...
                                            <select class="form-control text-size" name="status_pernikahan" disabled id="status_pernikahan">
                                    ...
                                    <div class="col-md-4 pasangan">
                                        <div class="form-group form-right">
                                            ...
                                            <input type="text" class="form-control text-size" name="nama_pasangan" id="nama_pasangan" value="<?= $leads->nama_konsumen ?>" disabled>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="col-md-4">
                                        <div class="form-group form-left">
                                            ...
                                            <select class="form-control text-size" name="lokasi_rumah" id="lokasi_rumah" disabled>
                                                <option selected value=""></option>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group form-center">
                                            ...
                                            <select class=" form-control text-size" name="jenis_rumah" id="jenis_rumah" disabled>
                                                <option selected value=""></option>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group form-right">
                                            ...
                                            <select class=" form-control text-size" name="luas_rumah" id="luas_rumah" disabled>
                                                <option selected value=""></option>
                                ...
                                <div class="form-row">
                                    <div class="col-md-12 event">
                                        <div class="form-group form-margin">
                                            ...
                                            <input type="text" class="form-control text-size" name="nama_event" id="nama_event" value="<?= $leads->nama_event ?>" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-12 form-agent">
                                        <div class="form-margin">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control text-size" name="nama_agent" id="nama_agent" value="<?= $leads->nama_agent ?>" aria-label="Recipient's username" aria-describedby="button-addon2" disabled>
                                    ...
                                    <div class="col-md-12 form">
                                        <div class="form-margin">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control text-size" name="nama_partner" id="nama_partner" value="<?= $leads->nama_partner ?>" aria-label="Recipient's username" aria-describedby="button-addon2" disabled>
                                                <div class="input-group-append">
                                    ...
                                    <div class="col-md-4 nik">
                                        <div class="form-group form-left">
                                            <label>NIK</label>
                                            <input type="phone" class="form-control text-size placement number-only" name="nik_egc" id="nik_egc" value="<?= $leads->nik_egc ?>" disabled minlength="6" maxlength="7" />
                                        </div>
                                    </div>
                                    <div class="col-md-4 posisi">
                                        <div class="form-group form-center">
                                            <label>Posisi</label>
                                            <input type="text" class="form-control text-size" name="posisi_egc" disabled id="posisi_egc" value="<?= $leads->posisi_egc ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-4 cabang">
                                        <div class="form-group form-right">
                                            <label>Cabang</label>
                                            <input type="text" class="form-control text-size" name="cabang_egc" disabled id="cabang_egc" value="<?= $leads->cabang_egc ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6 kontrak-ro">
                                        <div class="form-group form-left">
                                            <label>Nomor Kontrak</label>
                                            <input type="phone" class="form-control text-size placement number-only" name="nomor_kontrak" id="nomor_kontrak" value="<?= $leads->nomor_kontrak ?>" disabled minlength="10" maxlength="10" />
                                        </div>
                                    </div>
                                    <div class="col-md-6 konsumen-ro">
                                        <div class="form-group form-right">
                                            <label>Nama Konsumen</label>
                                            <input type="text" class="form-control text-size" name="referral_konsumen" id="referral_konsumen" value="<?= $leads->referral_konsumen ?>" disabled>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <div class="form-group form-left">
                                            ...
                                            <select class="form-control text-size" name="activity" disabled id="activity">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <input type="text" class="form-control text-size form-border" name="purpose_nama_merchant_1" value="<?= $data->purpose_nama_merchant_1 ?>" id="" placeholder="Nama Merchant / Toko 1" />
                                                    </td>
                                                    <td>
                                                        <input type="text" class="form-control text-size form-border" name="purpose_harga_1" value="<?= $data->purpose_harga_1 ?>" id="" placeholder="Harga 1" />
                                                    </td>
                                                    <td>
                                                        <input type="text" class="form-control text-size form-border" name="purpose_alamat_telepon_1" value="<?= $data->purpose_alamat_telepon_1 ?>" id="" placeholder="Alamat / Telepon 1" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <input type="text" class="form-control text-size form-border" name="purpose_nama_merchant_2" value="<?= $data->purpose_nama_merchant_2 ?>" id="" placeholder="Nama Merchant / Toko 2" />
                                                    </td>
                                                    <td>
                                                        <input type="text" class="form-control text-size form-border" name="purpose_harga_2" value="<?= $data->purpose_harga_2 ?>" id="" placeholder="Harga 2" />
                                                    </td>
                                                    <td>
                                                        <input type="text" class="form-control text-size form-border" name="purpose_alamat_telepon_2" value="<?= $data->purpose_alamat_telepon_2 ?>" id="" placeholder="Alamat / Telepon 2" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <input type="text" class="form-control text-size form-border" name="purpose_nama_merchant_3" value="<?= $data->purpose_nama_merchant_3 ?>" id="" placeholder="Nama Merchant / Toko 3" />
                                                    </td>
                                                    <td>
                                                        <input type="text" class="form-control text-size form-border" name="purpose_harga_3" value="<?= $data->purpose_harga_3 ?>" id="" placeholder="Harga 3" />
                                                    </td>
                                                    <td>
                                                        <input type="text" class="form-control text-size form-border" name="purpose_alamat_telepon_3" value="<?= $data->purpose_alamat_telepon_3 ?>" id="" placeholder="Alamat / Telepon 3" />
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                ...
                                <div class="collapse" id="kondisi">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group form-right">
                                                <label>Pekerjaan Pasangan</label>
                                                <select class="form-control text-size" name="condition_wir_tempat_kerja_pasangan" id="condition_wir_tempat_kerja_pasangan" required>
                                                    <option selected value="">Pilih Pekerjaan
                                                    </option>
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-12 resiko-pasangan">
                                            <div class="form-group form-margin">
                                                <label>Penjelasan Profesi Beresiko</label>
                                                <input type="text" class="form-control text-size" name="condition_wir_profesi_beresiko_pasangan" id="condition_wir_profesi_beresiko_pasangan" value="" placeholder="Penjelasan Profesi Beresiko" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="form-group form-left">
                                                <label>Tempat Kerja / Usaha pasangan</label>
                                                <input type="text" class="form-control text-size" name="condition_" id="" placeholder="Tempat Kerja / Usaha pasangan" />
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group form-right">
                                                <label>Tempat Kerja / Usaha pasangan</label>
                                                <input type="text" class="form-control text-size" name="condition_wir_kondisi_usaha" value="<?= $data->condition_wir_kondisi_usaha ?>" id="" placeholder="Jelaskan Kondisi Usaha Saat ini" />
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <table class="table table-hover">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control text-size number-only form-border total-operasional-wiraswasta" name="capacity_wir_sewa" value="<?= $data->capacity_wir_sewa ?>" id="" data-type="currency" required placeholder="Biaya
																				Sewa" />
                                                    </td>
                                                </tr>
                                                <tr>
                                            ...
                                            <table class="table table-hover">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" class="form-control text-size number-only form-border hutang-wiraswasta" name="capacity_wir_nilai_hutang1" value="<?= $data->capacity_wir_nilai_hutang1 ?>" id="" data-type="currency" required placeholder="Nominal 1" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <input type="text" class="form-control text-size number-only form-border hutang-wiraswasta" name="capacity_wir_nilai_hutang2" value="<?= $data->capacity_wir_nilai_hutang2 ?>" id="" data-type="currency" required placeholder="Nominal 2" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <input type="text" class="form-control text-size number-only form-border hutang-wiraswasta" name="capacity_wir_nilai_hutang3" value="<?= $data->capacity_wir_nilai_hutang3 ?>" id="" data-type="currency" required placeholder="Nominal 3" />
                                                        </td>
                                                    </tr>
                                                    <!-- <tr>
                                                    <td>
                        ...
                        <div class="card card-margin-survey">
                            <div class="card-body text-size">
                                <h5 class="form-margin mb-4"><b>Informasi Omset Konsumen</b>
                                    <a class="float-right omset-down" onclick="omsetdownFunction()" data-toggle="collapse" href="#omset" role="button" aria-expanded="false" aria-controls="collapseExample">
                                        <i class="fas fa-chevron-circle-down fa-lg"></i>
                                    </a>
                                </h5>
                                        ...
                                        <table class="table">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control text-size number-only form-border" name="capacity_wir_usaha_omset_perhari" value="<?= $data->capacity_wir_usaha_omset_perhari ?>" id="capacity_wir_usaha_omset_perhari" data-type="currency" required placeholder="Omset Perhari" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                ...
                                <div class="col-md-12 omset-up">
                                    <center>
                                        <h4 class="ml-3">
                                            <a onclick="omsetupFunction()" data-toggle="collapse" href="#omset" role="button" aria-expanded="false" aria-controls="collapseExample">
                                                <i class="fas fa-chevron-circle-up fa-lg"></i>
                                            </a>
                                        </h4>
                                    </center>
                                        ...
                                        <table class="table table-hover">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control text-size text-size form-border" name="" value="" id="" required placeholder="Status Barang 1" />
                                                    </td>
                                                    <td>
                                                        <input type="text" class="form-control text-size number-only form-border aset-konsumen" name="capital_harga1" value="<?= $data->capital_harga1 ?>" id="" data-type="currency" required placeholder="Harga Jual Pasar 1" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control text-size text-size form-border" name="" value="" id="" required placeholder="Status Barang 2" />
                                                    </td>
                                                    <td>
                                                        <input type="text" class="form-control text-size number-only  form-border aset-konsumen" name="capital_harga2" value="<?= $data->capital_harga2 ?>" id="" data-type="currency" required placeholder="Harga Jual Pasar 2" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control text-size text-size form-border" name="" value="" id="" required placeholder="Status Barang 3" />
                                                    </td>
                                                    <td>
                                                        <input type="text" class="form-control text-size number-only  form-border aset-konsumen" name="capital_harga3" value="<?= $data->capital_harga3 ?>" id="" data-type="currency" required placeholder="Harga Jual Pasar 3" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control text-size text-size form-border" name="" value="" id="" required placeholder="Status Barang 4" />
                                                    </td>
                                                    <td>
                                                        <input type="text" class="form-control text-size number-only  form-border aset-konsumen" name="capital_harga4" value="<?= $data->capital_harga4 ?>" id="" data-type="currency" required placeholder="Harga Jual Pasar 4" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <input type="text" class="form-control text-size form-border" name="capital_aset5" value="<?= $data->capital_aset5 ?>" id="" required placeholder="Nama Barang 5" />
                                                    </td>
                                                    <td>
                                                        <input type="text" class="form-control text-size text-size form-border" name="" value="" id="" required placeholder="Status Barang 5" />
                                                    </td>
                                                    <td>
                                                        <input type="text" class="form-control text-size number-only  form-border aset-konsumen" name="capital_harga5" value="<?= $data->capital_harga5 ?>" id="" data-type="currency" required placeholder="Harga Jual Pasar 5" />
                                                    </td>
                                                </tr>
                                                <tr class="bg-light">
                                                    <td>
