...
<div class="row">
        ...
        <form id="fs_konsumen" action="<?= base_url('fs_konsumen/update') ?>">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-left">
                                        ...
                                        <input type="text" class="form-control text-size"
                                            ...
                                            disabled placeholder="Kamea Dahayu Aditya" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group form-left">
                                        ...
                                        <input type="text" class="form-control text-size placement number-only"
                                            ...
                                            placeholder="0894 5533 985" maxlength="15" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group form-center">
                                        <label>Nomor WA</label>
                                        <input type="text" class="form-control text-size placement number-only" value=""
                                            readonly name="" id="" placeholder="0896 5533 985" maxlength="15" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group form-left">
                                            ...
                                            <input type="email" class="form-control text-size" name="email"
                                                value="<?= $leads->email ?>" readonly id="email" placeholder="Email">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group form-center">
                                            ...
                                            <input type="date" class="form-control text-size" name="tanggal_lahir"
                                                id="tanggal_lahir" value="<?= $leads->tanggal_lahir ?>" readonly
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group form-center">
                                            ...
                                            <select class="form-control text-size" name="status_pernikahan" readonly
                                    ...
                                    <div class="col-md-4 pasangan">
                                        <div class="form-group form-right">
                                            ...
                                            <input type="text" class="form-control text-size" name="nama_pasangan"
                                                id="nama_pasangan" value="<?= $leads->nama_konsumen ?>" readonly
                                ...
                                <div class="form-row">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="input-group-append">
                                                    <button class="btn btn-primary btn-data btn-cari text-size"
                                                        type="button" id="btn-data-agent" data-toggle="modal" disabled
                                    ...
                                    <div class="col-md-4 nik">
                                        <div class="form-group form-left">
                                            <label>NIK</label>
                                            <input type="phone" class="form-control text-size placement number-only"
                                                name="nik_egc" id="nik_egc" value="<?= $leads->nik_egc ?>" readonly
                                    ...
                                    <div class="col-md-4 posisi">
                                        <div class="form-group form-center">
                                            <label>Posisi</label>
                                            <input type="text" class="form-control text-size" name="posisi_egc" readonly
                                    ...
                                    <div class="col-md-4 cabang">
                                        <div class="form-group form-right">
                                            <label>Cabang</label>
                                            <input type="text" class="form-control text-size" name="cabang_egc" readonly
                                    ...
                                    <div class="col-md-6 kontrak-ro">
                                        <div class="form-group form-left">
                                            ...
                                            <input type="phone" class="form-control text-size placement number-only"
                                                ...
                                                value="<?= $leads->nomor_kontrak ?>" placeholder="087883774" readonly
                                    ...
                                    <div class="col-md-6 konsumen-ro">
                                        <div class="form-group form-right">
                                            ...
                                            <input type="text" class="form-control text-size" name="referral_konsumen"
                                                id="referral_konsumen" value="<?= $leads->referral_konsumen ?>" readonly
                                        ...
                                        <div class="form-group text-size form-right">
                                            ...
                                            <div class="form-check form-check-inline mt-2">
                                                <input class="form-check-input cross_branch" type="radio"
                                                    ...
                                                    <?= $leads->cross_branch == 'Ya' ? 'checked' : '' ?> disabled
                                                    value="Ya">
                                                <label class="form-check-label">
                                                    Ya
                                                </label>
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input cross_branch" type="radio"
                                                    name="cross_branch" id="cross_branch"
                                                    <?= $leads->cross_branch == 'Tidak' ? 'checked' : '' ?> disabled
                                                    value="Tidak">
                                                <label class="form-check-label">
                                                    Tidak
                                                </label>
                        ...
                        <div class="card-body text-size">
                            ...
                            <div class="collapse" id="pembiayaan">
                                ...
                                <div class="form-row form-margin">
                                    <div class="col-md-12">
                                        <p>Jumlah Tanggungan <small>(isi dengan jumlah orang)</small>()</p>
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <input type="text"
                                                                class="form-control text-size form-border table-form-400"
                                                        ...
                                                        <td>
                                                            <input type="text"
                                                                class="form-control text-size form-border table-form-220"
                                                        ...
                                                        <td>
                                                            <input type="text"
                                                                class="form-control text-size form-border table-form-300"
            ...
            <div class="col-md-12">
                <div class="card card-margin-survey">
                    <div class="card-body text-size">
                        <h5 class="form-margin"><b>Kondisi Konsumen</b>
                            <a class="float-right kondisi-down" onclick="kondisidownFunction()" data-toggle="collapse"
                                href="#kondisi" role="button" aria-expanded="false" aria-controls="collapseExample">
                                <i class="fas fa-chevron-circle-down fa-lg"></i>
                            </a>
                        </h5>
                        <div class="form-row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group form-right">
                                    <label>Tempat Kerja / Usaha pasangan</label>
                                    <select class="form-control text-size" name="condition_wir_tempat_kerja_pasangan"
                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                                <div class="form-group form-left resiko">
                                    <label>Penjelasan Profesi Beresiko</label>
                                    <input type="text" class="form-control text-size"
                                        name="condition_wir_profesi_beresiko" id="condition_wir_profesi_beresiko"
                                        value="<?= $data->condition_wir_profesi_beresiko ?>"
                                        placeholder="Penjelasan Profesi Beresiko" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group form-right resiko-pasangan">
                                    <label>Penjelasan Profesi Beresiko</label>
                                    <input type="text" class="form-control text-size"
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="bg-light">
                                                ...
                                                <td><input type="number"
                                                        ...
                                                        id="condition_wir_tanggungan_total" required
                                                        placeholder="Total Jumlah Tanggungan" readonly />
                                                </td>
                                            </tr>
                                        </tbody>
                            ...
                            <div class="form-row">
                                <div class="col-md-4">
                                    <div class="form-group form-left">
                                        ...
                                        <input type="text" class="form-control text-size number-only placement"
                                            ...
                                            value="<?= $data->condition_wir_tahun_berdiri ?>" id="" placeholder="2020"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group form-right">
                                        ...
                                        <select class="form-control text-size" name="condition_wir_jenis_bangunan_usaha"
                                            id="" required>
                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="form-group form-left">
                                        ...
                                        <select class="form-control text-size" name="condition_wir_pemilik_tempat_usaha"
                                            id="" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-right">
                                        ...
                                        <select class="form-control text-size" name="condition_wir_cara_bayar" id=""
                                            ...
                                            <option <?= $data->condition_wir_cara_bayar == 'Tunai' ? 'selected' : '' ?>
                                                value="Tunai">Tunai</option>
                                            <option
                                ...
                                <div class="col-md-12">
                                    <div class="form-group form-margin">
                                        ...
                                        <textarea class="form-control text-size" name="condition_wir_kondisi_usaha"
                                            value="<?= $data->condition_wir_kondisi_usaha ?>" id="" cols="30" rows="10"
            ...
            <div class="col-md-12">
                <div class="card card-margin-survey">
                    <div class="card-body text-size">
                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                                <div class="form-group form-left">
                                    ...
                                    <input type="text" class="form-control text-size number-only pendapatan-karyawan"
                                        name="capacity_karyawan_income_bruto"
                                        value="<?= $data->capacity_karyawan_income_bruto ?>" id="" data-type="currency"
                            ...
                            <div class="col-md-6">
                                <div class="form-group right">
                                    ...
                                    <input type="text" class="form-control text-size number-only pendapatan-karyawan"
                                        ...
                                        value="<?= $data->capacity_karyawan_income_thp ?>" id="" data-type="currency"
                                        placeholder="Rp. 000000000" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row form-margin mt-3 bonus-periodik">
                            <div class="col-md-12">
                                <p>Jumlah Tanggungan</p>
                                <div class="table-responsive">
                                    <table class="table">
                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                                <div class="form-group form-margin">
                                    <label>Nama Usaha</label>
                                    <input type=" text" class="form-control text-size" name="condition_wir_nama_usaha"
                                        value="<?= $data->condition_wir_nama_usaha ?>" id=""
                                        placeholder="PT BFI Syariah indonesia" required />
                                </div>
                            </div>
                            <div class="form-row form-margin mt-3 pendapatan-lainnya">
                                <div class="col-md-12">
                                                ...
                                                <tr class="bg-light">
                                                    ...
                                                    <td>
                                                        <input type="text"
                                                            ...
                                                            id="capacity_karyawan_total_income_lainnya"
                                                            data-type="currency" required placeholder="Nominal 2"
                                                            readonly />
                                                    </td>
                                                </tr>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-row form-margin mt-3 hutang-lainnya">
                                <div class="col-md-12">
                                                ...
                                                <tr class="bg-light">
                                                    ...
                                                    <td>
                                                        <input type="text"
                                                            ...
                                                            id="capacity_karyawan_total_hutang" data-type="currency"
                                                            required placeholder="Total Hutang" readonly />
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                    ...
                    <div class="col-md-12 kondisi-up">
                        <center>
                            <h4 class="ml-3">
                                <a onclick="kondisiupFunction()" data-toggle="collapse" href="#kondisi" role="button"
    ...
    <div class="col-md-12">
        <div class="card card-margin-survey">
            <div class="card-body text-size">
                <h5 class="form-margin"><b>Kapasitas Konsumen</b>
                    <a class="float-right kapasitas-down" onclick="kapasitasdownFunction()" data-toggle="collapse"
                        href="#kapasitas" role="button" aria-expanded="false" aria-controls="collapseExample">
                        <i class="fas fa-chevron-circle-down fa-lg"></i>
                    </a>
                </h5>
                            ...
                            <table class="table table-">
                                <tbody>
                                    ...
                                    <tr class="bg-light">
                                        ...
                                        <td></td>
                                        <td>
                                            <input type="text" class="form-control text-size number-only form-border"
                    ...
                    <div class="form-row">
                        <div class="col-md-4">
                            <div class="form-group form-margin">
                                ...
                                <input type="text" class="form-control text-size number-only"
                                    name="capacity_karyawan_saldo_rekening"
                                    value="<?= $data->capacity_karyawan_saldo_rekening ?>" id="" data-type="currency"
                                    placeholder="Rp. 000000000" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group form-margin">
                                ...
                                <input type="text" class="form-control text-size number-only"
                                    name="capacity_karyawan_income_pasangan"
                                    value="<?= $data->capacity_karyawan_income_pasangan ?>" id="" data-type="currency"
                                    placeholder="Rp. 000000000" />
                            </div>
                        </div>
                        <div class="col-md-4">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text"
                                                ...
                                                name="capacity_wir_nota1" value="<?= $data->capacity_wir_nota1 ?>" id=""
                                                data-type="currency" required placeholder="Bulan Pertama" />
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text"
                                                class="form-control text-size number-only form-border wiraswasta-nota"
                                                name="capacity_wir_nota2" value="<?= $data->capacity_wir_nota2 ?>" id=""
                                                data-type="currency" required placeholder="Bulan Kedua" />
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text"
                                                class="form-control text-size number-only form-border wiraswasta-nota"
                                                name="capacity_wir_nota3" value="<?= $data->capacity_wir_nota3 ?>" id=""
                                                data-type="currency" required placeholder="Bulan Ketiga" />
                                        </td>
                                    </tr>
                                    <tr class="bg-light">
                                        ...
                                        <td>
                                            <input type="text" class="form-control text-size number-only form-border"
                                                name="capacity_wir_avr_nota" value="<?= $data->capacity_wir_avr_nota ?>"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text"
                                            ...
                                            value="<?= $data->capacity_karyawan_outcome_listrik ?>" id=""
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text"
                                            ...
                                            value="<?= $data->capacity_karyawan_outcome_lainnya ?>" id=""
                                            data-type="currency" required placeholder="Biaya Lain - Lain" />
                                    </td>
                                </tr>
                                <tr class="bg-light">
                                    <td>
                                    ...
                                    <td>
                                        <input type="text" class="form-control text-size number-only form-border"
                                            ...
                                            id="capacity_karyawan_total_biaya_outcome" data-type="currency" required
            ...
            <div class=" form-row">
                <div class="col-md-6">
                    <div class="form-group form-margin">
                        ...
                        <div class="form-check form-check-inline mt-2">
                            <input class="form-check-input renovasi" type="radio" name="capacity_karyawan_ada_hutang"
                                <?= $data->capacity_karyawan_ada_hutang == 'Ya' ? 'checked' : '' ?> id="" value="Ya">
                            <label class="form-check-label">
                                Ya
                            </label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input renovasi" type="radio" name="capacity_karyawan_ada_hutang"
                                <?= $data->capacity_karyawan_ada_hutang == 'Tidak' ? 'checked' : '' ?> id=""
                                value="Tidak">
                            <label class="form-check-label">
                                Tidak
                            </label>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <input type="text" class="form-control text-size form-border"
                                            name="capacity_karyawan_hutang1"
                                            value="<?= $data->capacity_karyawan_hutang1 ?>" id="" required
                                            placeholder="Deskripsi 1" />
                                    </td>
                                    <td>
                                        <input type="text"
                                ...
                                <tr>
                                    <td>
                                        <input type="text" class="form-control text-size form-border"
                                            name="capacity_karyawan_hutang2"
                                            value="<?= $data->capacity_karyawan_hutang2 ?>" id="" required
                                            placeholder="Deskripsi 2" />
                                    </td>
                                    <td>
                                        <input type="text"
                                ...
                                <tr>
                                    <td>
                                        <input type="text" class="form-control text-size form-border"
                                            name="capacity_karyawan_hutang3"
                                            value="<?= $data->capacity_karyawan_hutang3 ?>" id="" required
                                            placeholder="Deskripsi 3" />
                                    </td>
                                    <td>
                                        <input type="text"
                                ...
                                <tr class="bg-light">
                                    ...
                                    <td>
                                        <input type="text" class="form-control text-size number-only form-border"
                                            name="capacity_karyawan_total_hutang"
                                            value="<?= $data->capacity_karyawan_total_hutang ?>"
                                            id="capacity_karyawan_total_hutang" data-type="currency" required
                        ...
                        <div class="form-group form-margin">
                            ...
                            <div class="form-check form-check-inline mt-2">
                                <input class="form-check-input renovasi" type="radio"
                                    ...
                                    <?= $data->capacity_wir_ada_income_lainnya == 'Ya' ? 'checked' : '' ?> id=""
                                    value="Ya">
                                <label class="form-check-label">
                                    Ya
                                </label>
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input renovasi" type="radio"
                                    name="capacity_wir_ada_income_lainnya"
                                    <?= $data->capacity_wir_ada_income_lainnya == 'Tidak' ? 'checked' : '' ?> id=""
                                    value="Tidak">
                                <label class="form-check-label">
                                    Tidak
                                </label>
                                    ...
                                    <tr>
                                        <td>
                                            <input type="text" class="form-control text-size form-border"
                                                ...
                                                value="<?= $data->capacity_wir_income_lain1 ?>" id="" required
                                                placeholder="Deskripsi 1" />
                                        </td>
                                        <td>
                                            <input type="text" class="form-control text-size number-only form-border"
                                    ...
                                    <tr>
                                        <td>
                                            <input type="text" class="form-control text-size form-border"
                                                ...
                                                value="<?= $data->capacity_wir_income_lain2 ?>" id="" required
                                                placeholder="Deskripsi 2" />
                                        </td>
                                        <td>
                                            <input type="text" class="form-control text-size number-only form-border"
                                    ...
                                    <tr class="bg-light">
                                        ...
                                        <td>
                                            <input type="text" class="form-control text-size number-only form-border"
                                                ...
                                                value="<?= $data->capacity_wir_total_lain ?>" id="" data-type="currency"
                                                required placeholder="Nominal 2" readonly />
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                ...
                <div class="form-row">
                    <div class="col-md-4">
                        <div class="form-group form-left">
                            <label>Saldo Rekening Saat ini</label>
                            <input type="text" class="form-control text-size number-only"
                                name="capacity_wir_saldo_rekening" value="<?= $data->capacity_wir_saldo_rekening ?>"
                                id="" data-type="currency" placeholder="Rp. 000000000" />
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group form-center">
                            <label>Pendapatan Pasangan</label>
                            <input type="text" class="form-control text-size number-only"
                                name="capacity_wir_income_pasangan" value="<?= $data->capacity_wir_income_pasangan ?>"
                                id="" data-type="currency" placeholder="Rp. 000000000" />
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group form-right">
                            ...
                            <input type="text" class="form-control text-size number-only"
                                ...
                                value="<?= $data->capacity_wir_total_nett_income ?>" id="" data-type="currency"
                                placeholder="Rp. 000000000" />
                        </div>
                    </div>
                </div>
        ...
        <div class="col-md-12 kapasitas-up">
            <center>
                <h4 class="ml-3">
                    <a onclick="kapasitasupFunction()" data-toggle="collapse" href="#kapasitas" role="button"
                        aria-expanded="false" aria-controls="collapseExample">
                        <i class="fas fa-chevron-circle-up"></i>
                    </a>
                </h4>
...
<div class="col-md-12">
    <div class="card card-margin-survey">
        <div class="card-body text-size">
            ...
            <div class="form-row">
                <div class="col-md-6">
                    <div class="form-group form-margin">
                        ...
                        <div class="form-check form-check-inline mt-2">
                            <input class="form-check-input renovasi" type="radio" name="capacity_wir_pilih_data_analisa"
                                <?= $data->capacity_wir_pilih_data_analisa == 'Nota' ? 'checked' : '' ?> id=""
                                value="Nota">
                            <label class="form-check-label">
                                Nota
                            </label>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text"
                                                    ...
                                                    data-type="currency" required placeholder="Total hutang" readonly />
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                    ...
                    <div class="form-row">
                        <div class="col-md-6">
                            <div class="form-group form-left">
                                <label>Total Pengeluaran</label>
                                <input type="text" class="form-control text-size number-only"
                                    name="capacity_wir_total_outcome" value="<?= $data->capacity_wir_total_outcome ?>"
                                    id="" data-type="currency" placeholder="Rp. 000000000" />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group form-right">
                                <label>Kelebihan Pendapatan</label>
                                <input type="text" class="form-control text-size number-only"
                                    name="capacity_wir_nett_income" value="<?= $data->capacity_wir_nett_income ?>" id=""
                                    data-type="currency" placeholder="Rp. 000000000" />
                            </div>
                        </div>
                    </div>
            ...
            <div class="collapse" id="kapasitas">
                <div class="form-row">
                    ...
                    <div class="form-row form-margin mt-3 omset-penjualan">
                        <div class="col-md-12">
                            <p>Informasi omset</p>
                            <div class="table-responsive">
                                <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text"
                                                    ...
                                                    value="<?= $data->capacity_wir_usaha_omset_perhari ?>" id=""
                                                    data-type="currency" required placeholder="Omset
																					Perhari" />
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text"
                                                    ...
                                                    value="<?= $data->capacity_wir_usaha_jumlah_hari_buka ?>" id=""
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text"
                                                    ...
                                                    value="<?= $data->capacity_wir_usaha_omset_perbulan ?>" id=""
                                                    data-type="currency" required placeholder="Omset per
																					bulan" />
                                            </td>
                                        </tr>
                                        <tr class="bg-light">
                                                    ...
                                                    <tr class="bg-light">
                                                        ...
                                                        <td>
                                                            <input type="text"
                                                                ...
                                                                name="capacity_wir_total_lain"
                                                                value="<?= $data->capacity_wir_total_lain ?>"
                                                                id="capacity_wir_total_lain" data-type="currency"
                                                                required placeholder="Nominal 2" readonly />
                                                        </td>
                                                    </tr>
                                                </tbody>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group form-margin">
                                            <label>Pendapatan Pasangan</label>
                                            <input type="text"
                                                class="form-control text-size number-only total-pendapatan-wiraswasta"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group form-margin">
                                            <label>Total Pendapatan</label>
                                            <input type="text"
                                                class="form-control text-size number-only kelebihan-pendapatan-wiraswasta"
                                                name="capacity_wir_total_nett_income"
                                                value="<?= $data->capacity_wir_total_nett_income ?>"
                                                id="capacity_wir_total_nett_income" data-type="currency"
                                                placeholder="Rp. 000000000" />
                                        </div>
                                    </div>
                                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text"
                                                                ...
                                                                value="<?= $data->capacity_wir_outcome_lainnya ?>"
                                                                id="capacity_wir_outcome_lainnya" data-type="currency"
                                                                required placeholder="Biaya Lain - Lain" />
                                                        </td>
                                                    </tr>
                                                    <tr class="bg-light">
                                                        <td>
                                                        ...
                                                        <td>
                                                            <input type="text"
                                                                class="form-control text-size number-only form-border total-pengeluaran-wiraswasta"
                                                                name="capacity_wir_total_biaya_outcome"
                                                                value="<?= $data->capacity_wir_total_biaya_outcome ?>"
                                                                id="capacity_wir_total_biaya_outcome"
                                                                data-type="currency" required
                                                                placeholder="Total Pengeluaran" readonly />
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text"
                                                                class="form-control text-size number-only form-border total-pengeluaran-wiraswasta"
                                                                name="capacity_wir_total_hutang"
                                                                value="<?= $data->capacity_wir_total_hutang ?>"
                                                                id="capacity_wir_total_hutang" data-type="currency"
                                                                required placeholder="Total hutang" readonly />
                                                        </td>
                                                    </tr>
                                                </tbody>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group form-margin">
                                            ...
                                            <input type="text"
                                                ...
                                                value="<?= $data->capacity_wir_total_outcome ?>"
                                                id="capacity_wir_total_outcome" data-type="currency"
                                                placeholder="Rp. 000000000" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group form-margin">
                                            ...
                                            <input type="text" class="form-control text-size number-only"
                                                ...
                                                value="<?= $data->capacity_wir_nett_income ?>"
                                                id="capacity_wir_nett_income" data-type="currency"
                                                placeholder="Rp. 000000000" />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-body text-size">
                                <h5 class="form-margin"><b>Aset Konsumen</b>
                                    <a class="float-right aset-down" onclick="asetdownFunction()" data-toggle="collapse"
                                        href="#aset" role="button" aria-expanded="false"
                                        aria-controls="collapseExample">
                                        <i class="fas fa-chevron-circle-down fa-lg"></i>
                                    </a>
                                </h5>
                                ...
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <div class="form-group form-left">
                                            ...
                                            <select class="form-control text-size" name="capital_tempat_tinggal_milik"
                                                id="" required>
                                                ...
                                                <option <?= $data->capital_tempat_tinggal_milik == 'Dinas' ?>
                                                    value="Dinas">
                                                    Dinas</option>
                                            </select>
                                        </div>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <input type="text"
                                                                    ...
                                                                    name="capital_aset1"
                                                                    value="<?= $data->capital_aset1 ?>" id="" required
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <input type="text"
                                                                    class="form-control text-size form-border"
                                                                    name="capital_aset2"
                                                                    value="<?= $data->capital_aset2 ?>" id="" required
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <input type="text"
                                                                    class="form-control text-size form-border"
                                                                    name="capital_aset3"
                                                                    value="<?= $data->capital_aset3 ?>" id="" required
                                                                    placeholder="Nama Barang 3" />
                                                            </td>
                                                            <td>
                                                                <input type="text"
                                                                    class="form-control text-size number-only  form-border aset-konsumen"
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <input type="text"
                                                                    class="form-control text-size form-border"
                                                                    name="capital_aset4"
                                                                    value="<?= $data->capital_aset4 ?>" id="" required
                                                                    placeholder="Nama Barang 4" />
                                                            </td>
                                                            <td>
                                                                <input type="text"
                                                                    class="form-control text-size number-only  form-border aset-konsumen"
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <input type="text"
                                                                    class="form-control text-size form-border"
                                                                    name="capital_aset5"
                                                                    value="<?= $data->capital_aset5 ?>" id="" required
                                                                    placeholder="Nama Barang5" />
                                                            </td>
                                                            <td>
                                                                <input type="text"
                                                                    class="form-control text-size number-only  form-border aset-konsumen"
                                                        ...
                                                        <tr class="bg-light">
                                                            ...
                                                            <td>
                                                                <input type="text"
                                                                    ...
                                                                    id="capital_total_aset" data-type="currency"
                                                                    required placeholder="Total Nilai Aset" readonly />
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                ...
                                <div class="col-md-12 aset-up">
                                    <center>
                                        <h4 class="ml-3">
                                            <a onclick="asetupFunction()" data-toggle="collapse" href="#aset"
                                                role="button" aria-expanded="false" aria-controls="collapseExample">
                                                <i class="fas fa-chevron-circle-up fa-lg"></i>
                                            </a>
                                        </h4>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <input type="text"
                                                                class="form-control text-size form-border"
                                                                name="character_nama1"
                                                                value="<?= $data->character_nama1 ?>" id=""
                                                                placeholder="Nama 1" />
                                                        </td>
                                                        <td>
                                                            <input type="text"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="text"
                                                                class="form-control text-size form-border"
                                                                name="character_nama2"
                                                                value="<?= $data->character_nama2 ?>" id=""
                                                                placeholder="Nama 2" />
                                                        </td>
                                                        <td>
                                                            <input type="text"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="text"
                                                                class="form-control text-size form-border"
                                                                name="character_nama3"
                                                                value="<?= $data->character_nama3 ?>" id=""
                                                                placeholder="Nama 3" />
                                                        </td>
                                                        <td>
                                                            <input type="text"
                                ...
                                <div class="collapse" id="konfirmasi">
                                    ...
                                    <div class="form-group form-margin">
                                        ...
                                        <textarea class="form-control text-size"
                                            name="character_hasil_kredit_media_lain" id="" cols="30" rows="10"
                                            placeholder="Haisl Keterangan Dari media Lain"
                                ...
                                <div class="form-row">
                                    <div class="col-md-4">
                                        <div class="form-group form-left">
                                            ...
                                            <select class="form-control text-size" name="collateral_merk" id=""
                                                required>
                                                ...
                                                <option
                                                    <?= $data->collateral_merk == 'Mercedes-Benz' ? 'selected' : '' ?>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group form-center">
                                            ...
                                            <select class="form-control text-size" name="collateral_jenis" id=""
                                                required>
                                                <option selected value="">Pilih jenis Kendaraan
                                                </option>
                                                <option <?= $data->collateral_jenis == 'PU' ? 'selected' : '' ?>
                                                    value="PU">
                                                    PU </option>
                                                ...
                                                <option
                                                    <?= $data->collateral_jenis == 'Heavy Truck' ? 'selected' : '' ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group form-right">
                                            ...
                                            <select class="form-control text-size" name="collateral_nama_bpkb" id=""
                                                ...
                                                <option
                                                    <?= $data->collateral_nama_bpkb == 'Sendiri' ? 'selected' : '' ?>
                                                    value="Sendiri">Sendiri</option>
                                                <option
                                                    <?= $data->collateral_nama_bpkb == 'Pasangan' ? 'selected' : '' ?>
                                                    value="Pasangan">Pasangan</option>
                                                <option
                                                    <?= $data->collateral_nama_bpkb == 'Orang Tua' ? 'selected' : '' ?>
                                                ...
                                                <option
                                                    <?= $data->collateral_nama_bpkb == 'Orang Lain' ? 'selected' : '' ?>
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-4">
                                            <div class="form-group form-left">
                                                ...
                                                <select class="form-control text-size"
                                                    name="collateral_lama_punya_mobil" id="" required>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group form-center">
                                                ...
                                                <select class="form-control text-size" name="collateral_guna_mobil"
                                                    id="" required>
                        ...
                        <div class="card card-margin-survey">
                            <div class="card-body text-size">
                                <h5 class="form-margin"><b>Data Religi</b>
                                    <a class="float-right religi-down" onclick="religidownFunction()"
                                        data-toggle="collapse" href="#religi" role="button" aria-expanded="false"
                                        aria-controls="collapseExample">
                                        <i class="fas fa-chevron-circle-down fa-lg"></i>
                                    </a>
                                </h5>
                                ...
                                <div class="collapse" id="religi">
                                    ...
                                    <div class="form-group form-margin">
                                        ...
                                        <select class="form-control text-size" name="religi_haji" id="" required>
                                            ...
                                            <option
                                                ...
                                                Jumlah Harta (Tabungan + Emas + Stok Barang Dagang) >100 Juta, Sudah
                                                Pernah
                                    ...
                                    <div class="form-group form-margin">
                                        ...
                                        <select class="form-control text-size" name="religi_umroh" id="" required>
                                            ...
                                            <option
                                                ...
                                                Jumlah Harta (Tabungan + Emas + Stok Barang Dagang) >60 Juta, Sudah
                                                Umroh,
                                    ...
                                    <div class="form-group form-margin">
                                        <label>Apakah pernah berhubungan dengan lembaga keuangan syariah
                                            ...
                                            ?</label>
                                        <select class="form-control text-size" name="religi_lembaga_syariah" id=""
                                            required>
                                            <option selected value="">Pilih Jawaban
                                            </option>
                                            <option
                                                <?= $data->religi_lembaga_syariah == 'Belum Pernah' ? 'selected' : '' ?>
                                                value="Belum Pernah">Belum Pernah</option>
                                            <option
                                                <?= $data->religi_lembaga_syariah == 'Sudah Pernah' ? 'selected' : '' ?>
                                    ...
                                    <div class="form-group form-margin">
                                        ...
                                        <select class="form-control text-size" name="religi_dosa_hutang" id="" required>
                                            ...
                                            <option
                                                ...
                                                Memahami</option>
                                            <option
                                                <?= $data->religi_dosa_hutang == 'Sangat Memahami' ? 'selected' : '' ?>
                                                value="Sangat Memahami">Sangat Memahami</option>
                                        </select>
                                    </div>
                                    <div class="form-group form-margin">
                                        <label>Alasan konsumen memilih lembaga keuangan syariah</label>
                                        <select class="form-control text-size" name="religi_alasan_syariah" id=""
                                            required>
        ...
        function condition_wir_tempat_kerja_pasangan() {
            ...
            condition_wir_tempat_kerja_pasangan();
        }
        $('#condition_wir_tempat_kerja_pasangan').change(function() {
            condition_wir_tempat_kerja_pasangan();
        })
        // resiko wiraswasta
        </script>
        ...
        $(document).ready(function() {
            ...
            $('#attachMoree').click(function() {
                ...
                moreUploadTag +=
                    ' <a class="btn btn-secondary float-right" href="javascript:del_file(' +
                    upload_number +
