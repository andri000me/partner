                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group form-right">
                                                ...
                                                <input type="text" class="form-control text-size placement number-only"
                                                    value="" readonly name="" id="" placeholder="0896 5533 985"
                                                    maxlength="15" />
                                            </div>
                                        </div>
                                    </div>
