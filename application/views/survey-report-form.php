                                ...
                                <div class="col-md-4">
                                    <div class="form-group text-size form-left">
                                        ...
                                        <div class="form-check form-check-inline mt-2">
                                            <input class="form-check-input" type="radio" name="" disabled id="" value="Laki - Laki">
                                            <label class="form-check-label">
                                                Laki - Laki
                                            </label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="" disabled id="" value="Perempuan">
                                            <label class="form-check-label">
                                                Perempuan
                                            </label>
                                        </div>
                    ...
                    <div class="card card-margin-survey">
                        <div class="card-body text-size">
                            ...
                            <div class="collapse" id="pembiayaan">
                                <p class="form-left mt-3 mb-4"> <b>Informasi Harga</b> </p>
                                ...
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <div class="form-group form-left resiko">
                                            <label>Penjelasan Profesi Beresiko</label>
                                            <input type="text" class="form-control text-size" name="condition_wir_profesi_beresiko" id="condition_wir_profesi_beresiko" value="<?= $data->condition_wir_profesi_beresiko ?>" placeholder="Penjelasan Profesi Beresiko" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="collapse" id="kapasitas">
                                                ...
                                                <table class="table">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" class="form-control text-size number-only form-border pendapatan-wiraswasta-lainnya" name="capacity_wir_nilai_lain1" value="<?= $data->capacity_wir_nilai_lain1 ?>" id="" data-type="currency" required placeholder="Nominal 1" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <input type="text" class="form-control text-size number-only form-border pendapatan-wiraswasta-lainnya" name="capacity_wir_nilai_lain2" value="<?= $data->capacity_wir_nilai_lain2 ?>" id="" data-type="currency" required placeholder="Nominal 2" />
                                                            </td>
                                                        </tr>
                                                        <tr class="bg-light">
                                                            <td>
                                                            ...
                                                            <td>
                                                                <input type="text" class="form-control text-size number-only form-border total-pendapatan-wiraswasta" name="capacity_wir_total_lain" value="<?= $data->capacity_wir_total_lain ?>" id="capacity_wir_total_lain" data-type="currency" required placeholder="Total Pendapatan" readonly />
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-4">
                                            <div class="form-group form-left">
                                                <label>Saldo Rekening Saat ini</label>
                                                <input type="text" class="form-control text-size number-only" name="capacity_wir_saldo_rekening" value="<?= $data->capacity_wir_saldo_rekening ?>" id="capacity_wir_saldo_rekening" data-type="currency" placeholder="Rp. 000000000" />
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group form-center">
                                                <label>Pendapatan Pasangan</label>
                                                <input type="text" class="form-control text-size number-only total-pendapatan-wiraswasta" name="capacity_wir_income_pasangan" value="<?= $data->capacity_wir_income_pasangan ?>" id="capacity_wir_income_pasangan" data-type="currency" placeholder="Rp. 000000000" />
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group form-right">
                                                <label>Total Pendapatan</label>
                                                <input type="text" class="form-control text-size number-only" name="capacity_wir_total_nett_income" value="<?= $data->capacity_wir_total_nett_income ?>" id="capacity_wir_total_nett_income" data-type="currency" placeholder="Rp. 000000000" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="form-group form-left">
                                                <label>Total Pengeluaran</label>
                                                <input type="text" class="form-control text-size number-only" name="capacity_wir_total_outcome" value="<?= $data->capacity_wir_total_outcome ?>" id="capacity_wir_total_outcome" data-type="currency" placeholder="Rp. 000000000" />
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group form-right">
                                                <label>Kelebihan Pendapatan</label>
                                                <input type="text" class="form-control text-size number-only" name="capacity_wir_nett_income" value="<?= $data->capacity_wir_nett_income ?>" id="capacity_wir_nett_income" data-type="currency" placeholder="Rp. 000000000" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class=" form-row">
                                                ...
                                                <table class="table">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" class="form-control text-size number-only form-border" name="capacity_wir_usaha_omset_perhari" value="<?= $data->capacity_wir_usaha_omset_perhari ?>" id="capacity_wir_usaha_omset_perhari" data-type="currency" required placeholder="Omset
																					Perhari" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" class="form-control text-size number-only form-border" name="capacity_wir_usaha_jumlah_hari_buka" value="<?= $data->capacity_wir_usaha_jumlah_hari_buka ?>" id="capacity_wir_usaha_jumlah_hari_buka" required placeholder="Jumlah
																					Hari Buka Usaha" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" class="form-control text-size number-only form-border" name="capacity_wir_usaha_omset_perbulan" value="<?= $data->capacity_wir_usaha_omset_perbulan ?>" id="capacity_wir_usaha_omset_perbulan" data-type="currency" required placeholder="Omset per
																					bulan" />
                                                            </td>
                                                        </tr>
                                                        <tr class="bg-light">
                                                            ...
                                                            <td>
                                                                <input type="text" class="form-control text-size number-only form-border" name="capacity_wir_total_omset" value="<?= $data->capacity_wir_total_omset ?>" id="capacity_wir_total_omset" data-type="currency" required placeholder="Total
																					Omset" readonly />
                                                            </td>
                                                        </tr>
                                                    </tbody>
...
<script>
    ...
    //pengeluaran wiraswasta (capacity)
