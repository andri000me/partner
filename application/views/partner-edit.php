    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <ol class="breadcrumb text-size">
                ...
                <li class="breadcrumb-item"><a href="<?= base_url('partner') ?>">Partnership</a></li>
        ...
        <div class="card m-b-20">
            <div class="card-body">
                <div id="wizard_container">
                    ...
                    <form action="<?= base_url('Partner/update') ?>" method="post" enctype="multipart/form-data"
                        class=" text-size">
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="search" class="form-control text-size"
                                                        ...
                                                        <div class="input-group-append">
                                                            ...
                                                            <button class="btn btn-primary text-size" type="button"
                                                                ...
                                                                data-target=".bd-example-modal-xl">Cari</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="email" class="form-control text-size" name="email"
                                                            ...
                                                            required placeholder="Aisha@bfisyariah.id" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control text-size" name="kategori_produk"
                                                            ...
                                                            <option
                                                                <?= $data->kategori_produk == 'My CarS' ? 'selected' : '' ?>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control text-size"
                                                            ...
                                                            value="<?= $data->bidang_usaha ?>" required
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control text-size" name="bentuk_usaha"
                                                            ...
                                                            <option
                                                                <?= $data->bentuk_usaha == 'Perorangan' ? 'selected' : '' ?>
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-12">
                                                <div class="form-group ml-3 mr-3">
                                                    ...
                                                    <input type="phone" class="form-control text-size" name="alamat"
                                                        id="alamat" value="<?= $data->alamat ?>" required
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group ml-3 mr-3">
                                                    ...
                                                    <input type="text" class="form-control text-size" name="kelurahan"
                                                        id="kelurahan" value="<?= $data->kelurahan ?>" required
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group ml-3 mr-3">
                                                    ...
                                                    <input type="text" class="form-control text-size" name="kecamatan"
                                                        id="kecamatan" value="<?= $data->kecamatan ?>" required
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-6">
                                                <div class="form-group ml-3 mr-3">
                                                    ...
                                                    <input type="text"
                                                        class="form-control placement text-size number-only"
                                                        name="kode_pos" id="kode_pos" value="<?= $data->kode_pos ?>"
                                                        required placeholder="16810" minlength="5" maxlength="6" />
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group ml-3 mr-3">
                                                    ...
                                                    <input type="text" class="form-control text-size" name="provinsi"
                                                        id="provinsi" value="<?= $data->provinsi ?>" required
                            ...
                            <div class="step text-size">
                                <div class="row">
                                    <div class="col-md-12 mb-2">
                                        <div class="ml-3">
                                            <h4 class="mt-0 header-title">Formulir Partnership</h4>
                                            <p class="text-muted text-size">Semua data dibutuhkan untuk keperluan
                                                analisa dan pengembangan strategi produk Syariah, hanya selangkah lagi
                                                proses ini selesai :)</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group ml-3 mr-3">
                                                        ...
                                                        <input type="text" class="form-control text-size"
                                                            ...
                                                            value="<?= $data->sosial_media ?>" required
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-12 mb-1">
                                                    <label class="ml-3 mr-3">Apa Saja Jenis Pembayaran Yang
                                                        Diterima</label>
                                                    <div class="form-group ml-3 mr-3">
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            ...
                                                            <label class="form-check-label"
                                                                for="inlineCheckbox2">Cicilan Konvensional</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group ml-3 mr-3">
                                                        ...
                                                        <input type="text" class="form-control text-size number-only"
                                                            ...
                                                            value="<?= $data->jumlah_cabang ?>" required
                                                            placeholder="5">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group ml-3 mr-3">
                                                        ...
                                                        <input type="text" class="form-control text-size"
                                                            ...
                                                            value="<?= $data->cabang_bank ?>" required
                                                    ...
                                                    <div class="form-group ml-3 mr-3">
                                                        ...
                                                        <div class="form-check form-check-inline mt-2">
                                                            <input class="form-check-input" type="radio"
                                                                ...
                                                                <?= $data->pernah_promosi == 'Ya' ? 'checked' : '' ?>
                                                                required value="Ya">
                                                            <label class="form-check-label">
                                                                Ya
                                                            </label>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group ml-3 mr-3">
                                                    ...
                                                    <input type="text" class="form-control text-size" name="hobi"
                                                        id="hobi" value="<?= $data->hobi ?>" placeholder="Memancing">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                                ...
                                                <div class="form-group ml-3 mr-3">
                                                    ...
                                                    <div class="form-check form-check-inline mt-2">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            <?= $data->punya_pinjaman == 'Ya' ? 'checked' : '' ?>
                                                            required value="Ya">
                                        ...
                                        <div class="form-row">
                                                ...
                                                <div class="form-group ml-3 mr-3">
                                                    ...
                                                    <div class="form-check form-check-inline mt-2">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            <?= $data->punya_giro_cek == 'Ya' ? 'checked' : '' ?>
                                                            required value="Ya">
                                                        <label class="form-check-label">
                                                            Ya
                                                        </label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group ml-3 mr-3">
                                                    ...
                                                    <div class="form-check form-check-inline mt-2">
                                                        <input class="form-check-input mou" type="radio" name="ttd_pks"
                                                            <?= $data->ttd_pks == 'Ya' ? 'checked' : '' ?> required
                                                            value="Ya">
                                                        <label class="form-check-label">
                                                            Ya
                                                        </label>
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input mou" type="radio" name="ttd_pks"
                                                            <?= $data->ttd_pks == 'Tidak' ? 'checked' : '' ?> required
                                                            value="Tidak">
                                                        <label class="form-check-label">
                                                            Tidak
                                                        </label>
                                            ...
                                            <div class="col-md-6">
                                                <div id="disable" class="form-group ml-3 mr-3">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        value="<?= $data->akhir_izin ?>" placeholder="2016"
                                                        minlength="4" maxlength="4">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group ml-3 mr-3">
                                                    ...
                                                    <textarea class="form-control text-size" name="keterangan_tambahan"
                                                        ...
                                                        value="<?= $data->keterangan_tambahan ?>" cols="30" rows="10"
                            ...
                            <div class="submit step text-size">
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        <div class="ml-3">
                                            <h4 class="mt-0 header-title">Formulir Partnership</h4>
                                            <p class="text-muted">Alhamdulillah, sudah pada bagian terakhir dari
                                                pendaftaran partner ini. Pastikan semua data yang dikirim benar dan
                                                valid .<br>Silahkan isi</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <div class="form-group text-size ml-3 mr-3">
                                            ...
                                            <input type="file" name="ktp" class="filestyle"
                                                data-buttonname="btn-secondary" <?= $data->ktp ? '' : 'required' ?>>
                                            <?php if ($data->ktp) { ?>
                                            <?php if (get_extension($data->ktp)) { ?>
                                            <div class="img-fluid mt-1">
                                                <a class="image-popup-vertical-fit"
                                                    href="<?= base_url('uploads/partners/' .   $data->ktp) ?>"
                                                    title="Foto Profile.">
                                                    <img class="d-flex align-self-start rounded mr-3 img-fluid" alt=""
                                                        src="<?= base_url('uploads/partners/' .   $data->ktp) ?>"
                                                        style="width: 150px; height: 150px;">
                                                </a>
                                            </div>
                                            <?php } else { ?>
                                            <div class="card text-center mt-2" style="height: 79px; width: 120px"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group text-size ml-3 mr-3">
                                            <label>NPWP</label>
                                            <input type="file" name="npwp" class="filestyle"
                                                data-buttonname="btn-secondary" <?= $data->npwp ? '' : 'required' ?>>
                                            <?php if ($data->npwp) { ?>
                                            <?php if (get_extension($data->npwp)) { ?>
                                            <div class="img-fluid mt-1">
                                                <a class="image-popup-vertical-fit"
                                                    href="<?= base_url('uploads/partners/' .   $data->npwp) ?>"
                                                    title="Foto Profile.">
                                                    <img class="d-flex align-self-start rounded mr-3 img-fluid" alt=""
                                                        src="<?= base_url('uploads/partners/' .   $data->npwp) ?>"
                                                        style="width: 150px; height: 150px;">
                                                </a>
                                            </div>
                                            <?php } else { ?>
                                ...
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <div class="form-group text-size ml-3 mr-3">
                                            ...
                                            <input type="file" name="buku_tabungan_perusahaan" class="filestyle"
                                                data-buttonname="btn-secondary"
                                                <?= $data->buku_tabungan_perusahaan ? '' : 'required' ?>>
                                            ...
                                            <?php } else { ?>
                                            <div class="card text-center mt-2" style="height: 79px; width: 120px"
                                                data-toggle="tooltip" title="<?= $data->buku_tabungan_perusahaan ?>">
                                                <a
                                                    href="<?= base_url('uploads/partners/' . $data->buku_tabungan_perusahaan) ?>">
                                                    <i class="fa fa-file fa-5x"></i>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group text-size ml-3 mr-3">
                                            ...
                                            <input type="file" name="siup" class="filestyle"
                                                data-buttonname="btn-secondary" <?= $data->siup ? '' : 'required' ?>>
                                            <?php if ($data->siup) { ?>
                                            <?php if (get_extension($data->siup)) { ?>
                                            <div class="img-fluid mt-1">
                                                <a class="image-popup-vertical-fit"
                                                    href="<?= base_url('uploads/partners/' .   $data->siup) ?>"
                                                    title="Foto Profile.">
                                                    <img class="d-flex align-self-start rounded mr-3 img-fluid" alt=""
                                                        src="<?= base_url('uploads/partners/' .   $data->siup) ?>"
                                                        style="width: 150px; height: 150px;">
                                                </a>
                                            </div>
                                            <?php } else { ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group text-size ml-3 mr-3">
                                            ...
                                            <input type="file" name="logo_perusahaan" class="filestyle"
                                                data-buttonname="btn-secondary"
                                                <?= $data->logo_perusahaan ? '' : 'required' ?>>
                                            <?php if ($data->logo_perusahaan) { ?>
                                            <?php if (get_extension($data->logo_perusahaan)) { ?>
                                            <div class="img-fluid mt-1">
                                                <a class="image-popup-vertical-fit"
                                                    href="<?= base_url('uploads/partners/' .   $data->logo_perusahaan) ?>"
                                                    title="Foto Profile.">
                                                    <img class="d-flex align-self-start rounded mr-3 img-fluid" alt=""
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group text-size ml-3 mr-3">
                                                ...
                                                <input type="file" name="foto_usaha" class="filestyle"
                                                    data-buttonname="btn-secondary"
                                                    <?= ($data->foto_usaha || $data->foto_usaha) ? '' : 'required' ?>>
                                                <?php if ($data->foto_usaha) { ?>
                                                <?php if (get_extension($data->foto_usaha)) { ?>
                                                <div class="img-fluid mt-1">
                                                    <a class="image-popup-vertical-fit"
                                                        href="<?= base_url('uploads/partners/' .   $data->foto_usaha) ?>"
                                                        title="Foto Profile.">
                                                        <img class="d-flex align-self-start rounded mr-3 img-fluid"
                                                            alt=""
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div id="lampiran_mou" class="form-group text-size ml-3 mr-3">
                                                ...
                                                <input type="file" id="form_mou" name="form_mou" class="filestyle"
                                                    data-buttonname="btn-secondary">
                                                <input type="hidden" name="form_mou"
                                                    <?= ($data->form_mou == '' || $data->form_mou == NULL) ? "disabled" : "value='$data->form_mou'"  ?>>
                                                <?php if ($data->form_mou) { ?>
                                                <?php if (get_extension($data->form_mou)) { ?>
                                                <div class="img-fluid mt-1">
                                                    <a class="image-popup-vertical-fit"
                                                        href="<?= base_url('uploads/partners/' .   $data->form_mou) ?>"
                                                        title="Foto Profile.">
                                                        <img class="d-flex align-self-start rounded mr-3 img-fluid"
                                                            alt=""
                                                            src="<?= base_url('uploads/partners/' .   $data->form_mou) ?>"
                                                            style="width: 150px; height: 150px;">
                                                    </a>
                                                </div>
                                                <?php } else { ?>
                                                <div class="card text-center mt-2" style="height: 79px; width: 120px"
                                                    data-toggle="tooltip" title="<?= $data->form_mou ?>">
                ...
                <table id=""
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <center><a href="#" id="search" class="btn btn-primary pilih"
