                                            ...
                                            <div class="form-row">
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <div class="input-group ml-3">
                                                        <input type="text" class="form-control text-size" name="nama_usaha" id="nama_usaha" value="<?= $data->nama_usaha ?>" required placeholder="CV Aria Santika" aria-label="Recipient's username" aria-describedby="button-addon2">
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-12">
                                                    <div class="form-group ml-3 mr-3">
                                                        ...
                                                        <input type="text" class="form-control placement text-size" onkeypress="return hanyaAngka(event);" name="telepon" id="telepon" value="<?= $data->telepon ?>" required placeholder="EG 0811977500" maxlength="15" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="form-group ml-3 mr-3">
                                                        ...
                                                        <div class="form-check form-check-inline mt-2">
                                                            <input class="form-check-input" type="radio" name="pernah_promosi" id="pernah_promosi" <?= $data->pernah_promosi == 'Ya' ? 'selected' : '' ?> required value="Ya">
                                                            <label class="form-check-label">
                                                                Ya
                                                            </label>
                                                        </div>
                                                        <div class="form-check form-check-inline ml-3 mr-3">
                                                            <input class="form-check-input" type="radio" name="pernah_promosi" id="pernah_promosi" <?= $data->pernah_promosi == 'Tidak' ? 'selected' : '' ?> required value="Tidak">
                                                            <label class="form-check-label">
                                                                Tidak
                                                            </label>
                                                        </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group ml-3 mr-3">
                                                        ...
                                                        <div class="form-check form-check-inline mt-2">
                                                            <input class="form-check-input" type="radio" name="on_going_project" id="on_going_project" <?= $data->on_going_project == 'Ada' ? 'selected' : '' ?> required value="Ada">
                                                            <label class="form-check-label">
                                                                Ada
                                                            </label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio" name="on_going_project" id="on_going_project" <?= $data->on_going_project == 'Tidak Ada' ? 'selected' : '' ?> required value="Tidak Ada">
                                                            <label class="form-check-label">
                                                                Tidak Ada
                                                            </label>
                                                        </div>
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="form-group ml-3 mr-3">
                                                        ...
                                                        <div class="form-check form-check-inline mt-2">
                                                            <input class="form-check-input" type="radio" name="punya_pinjaman" id="punya_pinjaman" value="Ya" <?= $data->punya_pinjaman == 'Ya' ? 'selected' : '' ?> required>
                                                            <label class="form-check-label text-size">
                                                                Ya
                                                            </label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio" name="punya_pinjaman" id="punya_pinjaman" value="Tidak" <?= $data->punya_pinjaman == 'Tidak' ? 'selected' : '' ?> required>
                                                            <label class="form-check-label text-size">
                                                                Tidak
                                                            </label>
                                                        </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group ml-3 mr-3">
                                                        ...
                                                        <div class="form-check  form-check-inline mt-2">
                                                            <input class="form-check-input" type="radio" name="punya_jumlah_plafond" id="punya_jumlah_plafond" value="Ya" <?= $data->punya_jumlah_plafond == 'Ya' ? 'selected' : '' ?> required>
                                                            <label class="form-check-label text-size">
                                                                Ya
                                                            </label>
                                                        </div>
                                                        <div class="form-check  form-check-inline">
                                                            <input class="form-check-input" type="radio" name="punya_jumlah_plafond" id="punya_jumlah_plafond" value="Tidak" <?= $data->punya_jumlah_plafond == 'Tidak' ? 'selected' : '' ?> required>
                                                            <label class="form-check-label text-size">
                                                                Tidak
                                                            </label>
                                                        </div>
