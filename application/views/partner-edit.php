                                    ...
                                    <div class="col-md-6">
                                        <div class="">
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-12">
                                                    <div class="form-margin">
                                                        <label>Apa Saja Jenis Pembayaran Yang
                                                            Diterima</label>
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="form-group form-left">
                                                        ...
                                                        <input type="text" class="form-control text-size number-only"
                                                            name="omset" id="omset" data-type="currency"
                                                            value="<?= $data->omset ?>" required
                                        ...
                                        <div class="form-group text-size form-margin">
                                            ...
                                            <div class="img-fluid mt-1">
                                                <a class="image-popup-vertical-fit"
                                                    ...
                                                    title="Foto Profile.">
                                                    <img class="d-flex align-self-start rounded mr-4 img-fluid" alt=""
                                ...
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <div class="form-group text-size form-margin">
                                            ...
                                            <input type="file" name="logo_perusahaan" class="filestyle upload-form"
                                            ...
                                            <div class="form-group text-size form-margin">
                                                ...
                                                <div class="img-fluid mt-1">
                                                    <a class="image-popup-vertical-fit"
                                                        ...
                                                        title="Foto Profile.">
                                                        <img class="d-flex align-self-start rounded mr-4 img-fluid"
                                                            alt=""
