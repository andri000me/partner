                    ...
                    <div class="form-row">
                        <div class="col-md-6">
                            <div class="form-group mr-3 ml-3 text-size">
                                ...
                                <input type="text" class="form-control text-size" name="nama_konsumen" id="nama_konsumen" required placeholder="Ibrahim Ahmad" />
                            </div>
                            <div class="form-group mr-3 ml-3 text-size">
                                <label>Nomor Telepon / Whatsapp</label>
                                <input type="text" class="form-control placement text-size" onkeypress="return hanyaAngka(event);" name="telepon" id="telepon" required placeholder="0811977500" maxlength="15" />
                            </div>
                            <div class="form-group mr-3 ml-3 text-size">
                                <label>Kota</label>
                                <input type="text" class="form-control text-size" name="kota" id="kota" required placeholder="Jakarta" />
                            </div>
                            <div class="form-group mr-3 ml-3 text-size">
                                <label>Cabang</label>
                                <input type="text" class="form-control text-size" name="cabang" id="cabang" required placeholder="Kali jodo" />
                            </div>
                            <div class="form-group mr-3 ml-3 text-size">
                                <label>Produk</label>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group mr-3 ml-3 text-size">
                                <label>Status</label>
                                <select class="form-control text-size" name="status" id="status">
