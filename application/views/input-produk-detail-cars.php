                        ...
                        <form class=" text-size" action="#" method="post">
                            ...
                            <!-- <div class="form-group ml-3 mr-3">
													...
													<select class="form-control text-size" name="input_produk"
														id="input_produk" required readonly>
                            ...
                            <div class="form-group ml-3 mr-3">
                                ...
                                <select class="form-control text-size cars" name="kategori_penyedia_barang" id="input_produk">
                                    ...
                                    <option value="Showroom Tanpa Izin Usaha">Showroom Tanpa Izin
                                        Usaha</option>
                                    <option value="Showroom Dengan Izin Usaha">Showroom Dengan Izin
                                        Usaha
                                    </option>
                                </select>
                            </div>
