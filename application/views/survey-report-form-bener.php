                ...
                <div class="tab-content card-margin-survey-right">
                    ...
                    <div class="tab-pane active p-3" id="nav-konsumen" role="tabpanel">
                        <form id="leads" action="<?= base_url('leads/update') ?>">
                            ...
                            <!-- Status Approval -->
                            <input type="hidden" id="status_approval" value="<?= $data->status_approval ?>">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group form-right">
                                                ...
                                                <input type="text" class="form-control text-size" name="detail_produk" id="detail_produk" value="<?= $data->detail_produk ?>" required placeholder="Paket umroh quad" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-row ro-active">
                                        <div class="col-md-6">
                                            <div class="form-group form-left">
                                                ...
                                                <input type="phone" class="form-control text-size placement number-only nomor_kontrak" name="nomor_kontrak" value="<?= $leads->nomor_kontrak ?>" minlength="10" maxlength="10" placeholder="0000000000" />
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group form-right">
                                                <label>Nama Konsumen</label>
                                                <input type="text" class="form-control text-size referral_konsumen" name="referral_konsumen" value="<?= $leads->referral_konsumen ?>" placeholder="Input Nama Konsumen">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <?php if ($this->fungsi->user_login()->level < 4) { ?>
                                            <div class="form-group form-margin float-right mt-5">
                                                ...
                                                <a href="<?= base_url('fs_konsumen/kirim_fs/' . $data->id_ticket) ?>" class="btn btn-primary waves-effect waves-light submit text-size" name="process"><b>Proses Data</b></a>
                                            </div>
                                        <?php } ?>
                                        <?php if ($this->fungsi->user_login()->level == 4) { ?>
                                            <div class="form-group form-margin float-right mt-5">
                                                <!-- <button type="button" class="btn btn-secondary text-size mr-1" onclick="document.getElementById('btn-religi').click()"><b>Kembali</b></button> -->
                                                <buttn class="btn btn-light waves-effect waves-light text-size btn-cari" id="return" name="return" class="btn" type="button"><b>Return</b></buttn>
                                                <a href="<?= base_url('fs_konsumen/kirim_fs/' . $data->id_ticket) ?>" class="btn btn-primary waves-effect waves-light submit text-size" name="process"><b>Proses Data</b></a>
                                            </div>
                                        <?php } ?>
                                    </div>
                ...
                <div class="card-body">
                    <div class="card-contents">
                        <ul class="nav nav-tabs nav-tabs-custom nav-justified" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#comment-tab" role="tab">
                                    <span class="d-block d-sm-none"><i class="far fa-comment-dots"></i></span>
                                    <span class="d-none d-sm-block">Comment <span class="badge badge-danger ml-1"></span></span>
                                </a>
                            </li>
                        </ul>
                        <div class="tab-content">
                            <div class="tab-pane active p-3" id="status" role="tabpanel">
