                                    ...
                                    <div class="form-group text-size form-right">
                                        ...
                                        <div class="form-check form-check-inline mt-2">
                                            <input class="form-check-input" type="radio" name="jenis_kelamin" id=""
                                                required
                                                <?= set_value('jenis_kelamin') == 'Laki - Laki' ? 'checked' : '' ?>
                                                value="Laki - Laki">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="jenis_kelamin" id=""
                                                required
                                                <?= set_value('jenis_kelamin') == 'Perempuan' ? 'checked' : '' ?>
                                                value="Perempuan">
                                            <label class="form-check-label">
                                                Perempuan
                                            </label>
                                    ...
                                    <div class="form-margin">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control text-size" name="nama_agent"
                                                id="nama_agent" value="<?= set_value('nama_agent') ?>"
                                    ...
                                    <div class="form-margin">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control text-size" name="nama_partner"
                                                id="nama_partner" value="<?= set_value('nama_partner') ?>"
                                                aria-label="Recipient's username" aria-describedby="button-addon2"
                                                readonly>
                                            <div class="input-group-append">
                                                <button class="btn btn-primary btn-data text-size" type="button"
