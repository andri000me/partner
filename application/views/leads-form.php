            ...
            <div class="card-body">
                <form action="<?= base_url('Leads/save') ?>" method="post" enctype="multipart/form-data" class=" text-size">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group text-size ml-4 mr-4">
                                        ...
                                        <div class="form-check form-check-inline mt-2">
                                            <input class="form-check-input" type="radio" name="jenis_rumah" <?= set_value('jenis_rumah') == 'Karyawan' ? 'checked' : '' ?> id="jenis_rumah" required value="Karyawan">
                                            <label class="form-check-label">
                                                Karyawan
                                            </label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="jenis_rumah" <?= set_value('jenis_rumah') == 'Wiraswasta' ? 'checked' : '' ?> id="jenis_rumah" required value="Wiraswasta">
                                            <label class="form-check-label">
                                                Wiraswasta
                                            </label>
                                        </div>
                                ...
                                <div class="col-md-12 form-agent mb-3">
                                    <div class="ml-4 mr-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-append">
                                                <button class="btn btn-primary btn-datatext-size" type="button" id="btn-data-agent" data-toggle="modal" data-target="">Cari</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12 form mb-3">
                                    <div class="ml-4 mr-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-append">
                                                <button class="btn btn-primary btn-datatext-size" type="button" id="btn-data" data-toggle="modal" data-target="">Cari</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="form-group mb-0 float-right mt-5 mr-4">
                        <button class="btn btn-light waves-effect waves-light text-size" id="draft" name="draft" class="btn" type="submit">Simpan</button>
