                            ...
                            <div class="form-row">
                                <div class="col-md-12">
                                    <div class="form-group ml-3 mr-3">
                                        ...
                                        <input type="text" class="form-control text-size placement <?= form_error('leads_id') ? 'is-invalid' : '' ?>" name="leads_id" id="leads_id" value="<?= set_value('leads_id') ?>" required placeholder="009377736433744" maxlength="15">
                                        <?= form_error('leads_id') ?>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group ml-3 mb-3">
                                        <input type="search" class="form-control text-size" name="nama_konsumen" id="nama_konsumen" value="<?= set_value('nama_konsumen') ?>" required placeholder="Ibrahim Ahmad" aria-label="Recipient's username" aria-describedby="button-addon2">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mr-3 ml-3">
                                        ...
                                        <input type="text" class="form-control text-size" name="detail_produk" id="detail_produk" value="<?= set_value('detail_produk') ?>" required placeholder="Contoh : " />
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                            ...
                            <div class="form-row">
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group flex-nowrap ml-3 mb-3">
                                        ...
                                        <input type="text" class="form-control text-size mr-4 number-only" name="nilai_funding" id="nilai_funding" data-type="currency" value="<?= set_value('nilai_funding') ?>" required placeholder="3,000,000" aria-label="Username" aria-describedby="addon-wrapping">
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="<?= base_url('leads') ?>"><button class="btn btn-primary">OK</button></a>
            </div>
        </div>
    </div>
</div>
