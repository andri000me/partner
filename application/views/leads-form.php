                ...
                <form action="<?= base_url('Leads/save') ?>" method="post" enctype="multipart/form-data"
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            ...
                            <p class="text-muted text-size">Pilih data yang sudah anda input pada leads database jika
                                ada atau input baru. Pastikan Leads ID sesuai dengan sistem LOS untuk memudahkan
                                pencocokan data. Form ini digunakan untuk keperluan KPI, Bonus dan NST.</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                                        ...
                                        <div class="ml-3 mr-3">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control text-size" name="nama_konsumen"
                                                    id="nama_konsumen" value="<?= set_value('nama_konsumen') ?>"
                                                    required placeholder="Ibrahim Ahmad"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group ml-3 mr-3">
                                            ...
                                            <input type="phone"
                                                ...
                                                placeholder="0786687587253564" minlength="16" maxlength="16" />
                                            <?= form_error('no_ktp') ?>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group ml-3 mr-3">
                                            ...
                                            <input type="text" class="form-control text-size" name="detail_produk"
                                                ...
                                                placeholder="Paket Umroh ABC Quad" />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="col-md-12">
                                        <div class="form-group ml-3 mr-3">
                                            ...
                                            <select class="form-control text-size" name="soa" id="soa" required>
                                                ...
                                                <option <?= set_value('soa') == 'EGC' ? 'selected' : '' ?> value="EGC">
                                                    EGC</option>
                                                <option <?= set_value('soa') == 'CGC' ? 'selected' : '' ?> value="CGC">
                                                    CGC</option>
                                                <option <?= set_value('soa') == 'Digital Marketing' ? 'selected' : '' ?>
                                                    value="Digital Marketing">Digital Marketing</option>
                                                <option
                                                    <?= set_value('soa') == 'Website BFI Syariah' ? 'selected' : '' ?>
                                ...
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <div class="form-group text-size">
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input cross_branch" type="radio"
                                                    name="cross_branch" id="cross_branch"
                                                    <?= set_value('cross_branch') == 'Tidak' ? 'checked' : '' ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group text-size">
                                            ...
                                            <div class="form-check form-check-inline mt-2">
                                                <input class="form-check-input" type="radio" name="sudah_funding"
                                                    id="sudah_funding"
                                                    <?= set_value('sudah_funding') == 'Sudah' ? 'checked' : '' ?>
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="sudah_funding"
                                                    id="sudah_funding"
                                                    <?= set_value('sudah_funding') == 'Belum' ? 'checked' : '' ?>
                                                    checked required value="Belum">
                                                <label class="form-check-label">
                                                    Belum
                                                </label>
                                            </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control text-size" name="follow_up_by" id="follow_up_by"
                                                ...
                                                <option
                                                    <?= set_value('follow_up_by') == 'Kunjungan' ? 'selected' : '' ?>
                                        ...
                                        <div class="form-group text-size">
                                            ...
                                            <div class="form-check form-check-inline mt-2">
                                                <input class="form-check-input" type="radio" name="appeal_nst"
                                                    id="appeal_nst"
                                                    <?= set_value('appeal_nst') == 'Ya' ? 'checked' : '' ?> required
                                                    value="Ya">
                                                <label class="form-check-label">
                                                    Ya
                                                </label>
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="appeal_nst"
                                                    id="appeal_nst"
                                                    <?= set_value('appeal_nst') == 'Tidak' ? 'checked' : '' ?> required
                                                    value="Tidak">
                                                <label class="form-check-label">
                                                    Tidak
                                                </label>
