                            ...
                            <form class=" text-size" action="<?= base_url('Partner/update_detail') ?>" method="post">
                                ...
                                <div class="form-group mb-0 mt-2 float-right btn-maintain">
                                    ...
                                    <a class="btn btn-info text-size"
                                        ...
                                        href="<?= base_url('ticket/approve_status/' . $ticket->id_ticket) ?>">Approve</a>
                                    <?php } ?>
                                    ...
                                    <a class="btn btn-danger text-size"
                                        ...
                                        href="<?= base_url('ticket/reject_status/' . $ticket->id_ticket) ?>">Reject</a>
                                    <?php } ?>
                                    <?php if ($level < 4) { ?>
                                    <button type="submit"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="owl-carousel owl-theme">
                                        ...
                                        <div class="item" style="height:150px; width:300px;">
                                            ...
                                            <div class="zoom-gallery">
                                                <a
                                                    href="<?= base_url('uploads/partners/' . $data->foto_usaha_mapping) ?>"><img
                                                        src="<?= base_url('uploads/partners/' . $data->foto_usaha_mapping) ?>"
                                                        alt="" style="height:150px; width:300px;"></a>
                                            </div>
                                            <?php } else { ?>
                                            <a href="<?= base_url('uploads/partners/' . $data->foto_usaha_mapping) ?>">
                                                <div class="card text-center" style="height: 150px; width: 300px"
                                                    data-toggle="tooltip" title="<?= $data->foto_usaha_mapping ?>">
                                                    <i class="fa fa-file fa-5x"></i>
