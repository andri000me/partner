                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="input-group-append">
                                                        <button class="btn btn-light btn-data btn-cari text-size"
                                                            ...
                                                            data-target=""
                                                            <?= $cabang_asal == $data->cabang_cross ? 'disabled' : '' ?>>Cari</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <table id=""
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <center><button class="btn btn-primary pilih-leads"
                                        ...
                                        data-cabangegc="<?= $mapping->cabang_egc ?>">Pilih</button></center>
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
...
function source_leads() {
    if ($('#soa').val() == 'Direct Selling') {
        ...
        $('.travel, .agent, .jasa, .event, .btn-data, .form, .form-agent, .nik, .posisi, .cabang, .kontrak-cgc, .konsumen-cgc, .kontrak-ro, .konsumen-ro, .vendor, #data_partner')
            .val('');
