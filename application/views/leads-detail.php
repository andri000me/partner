                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group text-size form-right">
                                                ...
                                                <input type="text" class="form-control placement number-only text-size"
                                                    name="nomor_wa" id="" value="<?= $data->nomor_wa ?>"
                                                    <?= $cabang_asal == $data->cabang_cross ? 'readonly' : '' ?>
                                                    required placeholder="0896 5533 985" maxlength="15">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group form-right">
                                                ...
                                                <select class="form-control text-size" name="pendidikan" id="pendidikan"
                                                    ...
                                                    <option <?= $data->pendidikan == 'SMU' ? 'selected' : '' ?>
                                                        value="SMU">SMU</option>
                                                    <option <?= $data->pendidikan == 'SLTA' ? 'selected' : '' ?>
                                                        value="SLTA">SLTA</option>
                                                    <option <?= $data->pendidikan == 'STM' ? 'selected' : '' ?>
                                                        value="STM">STM</option>
                                                    <option <?= $data->pendidikan == 'SMEA' ? 'selected' : '' ?>
                                                        value="SMEA">SMEA</option>
                                                    <option <?= $data->pendidikan == 'D1' ? 'selected' : '' ?>
                                                        value="D1">D1</option>
                                                    <option <?= $data->pendidikan == 'D2' ? 'selected' : '' ?>
                                                        value="D2">D2</option>
                                                    <option <?= $data->pendidikan == 'D3' ? 'selected' : '' ?>
                                                        value="D3">D3</option>
                                                    <option <?= $data->pendidikan == 'S1' ? 'selected' : '' ?>
                                                        value="S1">S1</option>
                                                    <option <?= $data->pendidikan == 'S2' ? 'selected' : '' ?>
                                                        value="S2">S2</option>
                                                    <option <?= $data->pendidikan == 'S3' ? 'selected' : '' ?>
                                                        value="S3">S3</option>
                                                </select>
                                                <input type="hidden" name="pendidikan" value="<?= $data->pendidikan ?>"
                                                    <?= $cabang_asal != $data->cabang_cross ? 'disabled' : '' ?>>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group form-margin">
                                                ...
                                                <input type="text" class="form-control text-size" name="nama_pasangan"
                                                    value="<?= $data->nama_pasangan ?>" id="nama_pasangan"
                                                    <?= $cabang_asal == $data->cabang_cross ? 'readonly' : '' ?>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group form-right">
                                                ...
                                                <input type="hidden" name="status_konsumen"
                                                    value="<?= $data->status_konsumen ?>"
                                                    <?= $cabang_asal != $data->cabang_cross ? 'disabled' : '' ?>>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group form-margin">
                                                ...
                                                <select class="form-control text-size" name="lokasi_rumah"
                                                    ...
                                                    <option
                                                        ...
                                                        value="Non Perumahan - Jalan Satu Mobil">Non Perumahan -
                                                        Jalan Satu Mobil</option>
                                                    <option
                                                        <?= $data->lokasi_rumah == 'Non Perumahan - Jalan Dua Mobil' ? 'selected' : '' ?>
                                                        value="Non Perumahan - Jalan Dua Mobil">Non Perumahan -
                                                    ...
                                                    <option
                                                        ...
                                                        value="Perumahan - Jalan Dua Mobil">Perumahan - Jalan Dua
                                                        Mobil</option>
                                                </select>
                                                <input type="hidden" name="lokasi_rumah"
                                                    value="<?= $data->lokasi_rumah ?>"
                                                    <?= $cabang_asal != $data->cabang_cross ? 'disabled' : '' ?>>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                            ...
                                            <div class="form-group text-size form-left">
                                                ...
                                                <div class="form-check form-check-inline mt-2">
                                                    <input class="form-check-input" type="radio" name="jenis_rumah"
                                                        <?= $data->jenis_rumah == 'Semi Permanent' ? 'checked' : '' ?>
                                                        id="jenis_rumah" required
                                                        <?= $cabang_asal == $data->cabang_cross ? 'disabled' : '' ?>
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="jenis_rumah"
                                                        <?= $data->jenis_rumah == 'Permanent' ? 'checked' : '' ?>
                                                        id="jenis_rumah" required
                                                        <?= $cabang_asal == $data->cabang_cross ? 'disabled' : '' ?>
                                                        value="Permanent">
                                                    <label class="form-check-label">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group form-right">
                                                ...
                                                <input type="hidden" name="luas_rumah" value="<?= $data->luas_rumah ?>"
                                                    <?= $cabang_asal != $data->cabang_cross ? 'disabled' : '' ?>>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group form-left">
                                                ...
                                                <select class="form-control text-size" name="soa" id="soa" required
                                                    ...
                                                    <option <?= $data->soa == 'Walk In' ? 'selected' : '' ?>
                                            ...
                                            <div class="form-group form-right">
                                                ...
                                                <select class="form-control text-size" name="activity_marketing"
                                                    ...
                                                    <option
                                                        ...
                                                        value="Direct Selling">Direct Selling</option>
                                                    <option
                                                        <?= $data->activity_marketing == 'Tele call' ? 'selected' : '' ?>
                                                        value="Tele call">Tele call</option>
                                                    <option
                                                        <?= $data->activity_marketing == 'Digital Marketing' ? 'selected' : '' ?>
                                                        value="Digital Marketing">Digital Marketing</option>
                                                    <option
                                                        <?= $data->activity_marketing == 'Sosial Media' ? 'selected' : '' ?>
                                                        value="Sosial Media">Sosial Media</option>
                                                    <option
                                                        <?= $data->activity_marketing == 'Website' ? 'selected' : '' ?>
                                        ...
                                        <div class="col-md-12 event text-size">
                                            <div class="form-group form-margin">
                                                ...
                                                <input type="text" class="form-control text-size"
                                                    value="<?= $data->nama_event ?>" name="nama_event" id="nama_event"
                                            ...
                                            <div class="form-margin">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control text-size readonly pointer"
                                                        ...
                                                        value="<?= $data->nama_agent ?>"
                                                        aria-label="Recipient's username"
                                                        aria-describedby="button-addon2">
                                                    <div class="input-group-append">
                                                        <button class="btn btn-primary btn-data text-size" type="button"
                                                            id="btn-data-agent" data-toggle="modal" data-target=""
                                                            <?= $cabang_asal == $data->cabang_cross ? 'disabled' : '' ?>><b>Cari</b></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-margin">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control text-size readonly pointer"
                                                        ...
                                                        value="<?= $data->nama_partner ?>"
                                                        aria-label="Recipient's username"
                                                        aria-describedby="button-addon2">
                                                    <div class="input-group-append">
                                                        <button class="btn btn-primary btn-data text-size" type="button"
                                                            id="btn-data" data-toggle="modal" data-target=""
                                                            <?= $cabang_asal == $data->cabang_cross ? 'disabled' : '' ?>><b>Cari</b></button>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <fieldset <?= $cabang_asal == $data->cabang_cross ? 'disabled' : '' ?>>
                                                <div class="form-group form-left">
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input cross_branch text-size"
                                                            type="radio" name="cross_branch"
                                                            <?= $data->cross_branch == 'Tidak' ? 'checked' : '' ?>
                                                ...
                                                <div id="hide" class="form-group form-right">
                                                    ...
                                                    <select class="form-control text-size" name="cabang_cross"
                                                        ...
                                                        <option
                                                            ...
                                                            <?= $branch->id_branch == $cabang_asal ? 'disabled' : '' ?>
                                ...
                                <div class="col-md-12">
                                    <form action="" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div id="moreImageUploadLink" class="float-right mt-3">
                                            <a class="btn btn-secondary mr-1 text-size" href="javascript:void(0);"
                                                id="attachMore"><b>Tambah Form</b></a>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#profile1" role="tab">
                                    ...
                                    <span class="d-none d-sm-block">Comment <span
                                            class="badge badge-danger m-1 "><?= $comments->num_rows() ?></span></span>
                                </a>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="inbox-item-author mt-0 mb-1 text-size"><b><a
                                                                href="<?= base_url('zip/create_zip/' . $ticket->id_ticket . '/partners') ?>">Download
                            ...
                            <div class="tab-pane p-3" id="profile1" role="tabpanel">
                                ...
                                <form action="<?= base_url('Comment/save') ?>" method="post">
                                    ...
                                    <div class="form-group">
                                        <label>Comment</label>
                                        <textarea class="form-control" name="comment" id="comment-text" cols="30"
                                            rows="10" required placeholder="tulis comment disini"
                ...
                <table id="" class="datatable-modal table table-hover dt-responsive wrap text-size table-modal"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <center><button class="btn btn-primary pilih-leads radius"
                                        ...
                                        data-cabangegc="<?= $mapping->cabang_egc ?>"><b>Pilih</b></button></center>
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
