...
<div class="row">
    <!-- <div class="col-md-12">
        <div class="btn-kanan mb-2 card-margin-2">
            <a href="<?= base_url('leads/create') ?>"><button class="btn btn-primary text-size"><b>Buat Data</b></button></a>
        </div>
    </div> -->
    <div class="col-12">
                ...
                <ul class="nav nav-tabs nav-tabs-custom" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#pending" role="tab">
                            <span class="d-block d-sm-none">Pending <span class="badge badge-danger"><?= $pending->num_rows() ?></span></span>
                            <span class="d-none d-sm-block">Pending <span class="badge badge-danger"><?= $pending->num_rows() ?></span></span>
                        </a>
                    </li>
                    <li class="nav-item">
                            ...
                            <tbody>
                                <?php foreach ($data->result() as $fs_konsumen) { ?>
                                    <tr>
                                        ...
                                        <?php } ?>
                                        <td>
                                            <center><a href="<?= base_url('fs_konsumen/create/' . $fs_konsumen->id) ?>" class="btn btn-primary text-size radius">Detail</a>
                                            </center>
                                        </td>
                                    </tr>
                                <?php } ?>
