                ...
                <div class="tab-content">
                    <div class="tab-pane active p-3" id="partner" role="tabpanel">
                        ...
                        <input type="hidden" name="redirect" value="<?= uri_string() ?>">
                            ...
                            <div class="form-group ml-3 mr-3">
                                ...
                                <input type="text" class="form-control text-size" name="input_produk" id="input_produk" value="My Cars" required readonly />
                            </div>
                            <div class="form-group ml-3 mr-3">
                                <label>Nama Penyedia Barang</label>
                                <input type="text" class="form-control text-size cars" name="nama_penyedia" value="<?= $data->nama_penyedia ?>" id="nama_penyedia" placeholder="Nama Penyedia Barang" />
                            </div>
                            <div class="form-group ml-3 mr-3">
                                <label>Jenis Penyedia Barang</label><br>
                                <div class="form-check form-check-inline mt-2">
                                    <input class="form-check-input cars" type="radio" name="jenis_penyedia" <?= $data->jenis_penyedia == 'Authorized' ? 'checked' : '' ?> value="Authorized">
                                    <label class="form-check-label">
                                        Authorized
                                    </label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input cars" type="radio" name="jenis_penyedia" <?= $data->jenis_penyedia == 'Non-Authorized' ? 'checked' : '' ?> value="Non-Authorized">
                                    <label class="form-check-label">
                                        Non-Authorized
                                    </label>
                                </div>
                            ...
                            <div class="form-group ml-3 mr-3">
                                ...
                                <select class="form-control text-size cars" name="kategori_penyedia" id="input_produk">
                                    ...
                                    <option <?= $data->kategori_penyedia == 'Dealer ATPM' ? 'selected' : '' ?> value="Dealer ATPM">Dealer ATPM</option>
                                    <option <?= $data->kategori_penyedia == 'Penjual Perorangan' ? 'selected' : '' ?> value="Penjual Perorangan">Penjual Perorangan</option>
                                    <option <?= $data->kategori_penyedia == 'Pemilik Langsung' ? 'selected' : '' ?> value="Pemilik Langsung">Pemilik Langsung</option>
                                    <option <?= $data->kategori_penyedia == 'Showroom Tanpa Izin Usaha' ? 'selected' : '' ?> value="Showroom Tanpa Izin Usaha">Showroom Tanpa Izin
                                        Usaha</option>
                                    <option <?= $data->kategori_penyedia == 'Showroom Dengan Izin Usaha' ? 'selected' : '' ?> value="Showroom Dengan Izin Usaha">Showroom Dengan Izin
                                        Usaha
                                    </option>
                                </select>
                            </div>
                            <div class="form-group ml-3 mr-3">
                                ...
                                <div class="form-check form-check-inline mt-2">
                                    <input class="form-check-input cars" type="radio" name="kategori_aset" <?= $data->kategori_aset == 'New Car' ? 'checked' : '' ?> value="New Car">
                                    <label class="form-check-label">
                                        New Car
                                    </label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input cars" type="radio" name="kategori_aset" <?= $data->kategori_aset == 'Used Car' ? 'checked' : '' ?> value="Used Car">
                                    <label class="form-check-label">
                                        Used Car
                                    </label>
                                </div>
                            ...
                            <div class="form-group ml-3 mr-3">
                                ...
                                <input type="text" class="form-control text-size cars" name="lama_usaha" value="<?= $data->lama_usaha ?>" id="lama_usaha" placeholder="Lama Usaha" />
                            </div>
                            <div class="form-group ml-3 mr-3">
                                <label>Kepemilikan Tempat Usaha</label><br>
                                <div class="form-check form-check-inline mt-2">
                                    <input class="form-check-input cars" type="radio" name="kepemilikan_tempat" <?= $data->kepemilikan_tempat == 'Milik Sendiri' ? 'checked' : '' ?> value="Milik Sendiri">
                                    <label class="form-check-label">
                                        Milik Sendiri
                                    </label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input cars" type="radio" name="kepemilikan_tempat" <?= $data->kepemilikan_tempat == 'Sewa' ? 'checked' : '' ?> value="Sewa">
                                    <label class="form-check-label">
                                        Sewa
                                    </label>
                                </div>
                            ...
                            <div class="form-group ml-3 mr-3">
                                ...
                                <input type="number" class="form-control text-size cars number-only" name="jumlah_stok" value="<?= $data->jumlah_stok ?>" id="jumlah_stok" placeholder="Jumlah Stok Unit" />
                            </div>
                            <div class="form-group ml-3 mr-3">
                                <label>Tipe Kendaraan</label>
                                <input type="text" class="form-control text-size cars" name="tipe_kendaraan" value="<?= $data->tipe_kendaraan ?>" id="tipe_kendaraan" placeholder="Tipe kendaraan" />
                            </div>
                            <div class="form-group ml-3 mr-3">
                                <label>Tahun</label>
                                <input type="date" class="form-control text-size cars placement" name="tahun" value="<?= $data->tahun ?>" id="tahun" minlength="4" maxlength="4" />
                            </div>
                            <div class="form-group ml-3 mr-3">
                                <label>Warna kendaraan</label>
                                <input type="text" class="form-control text-size cars" name="warna_kendaraan" value="<?= $data->warna_kendaraan ?>" id="warna_kendaraan" placeholder="Warna kendaraan" />
                            </div>
                            <div class="ml-3 mr-3 mb-3">
                                ...
                                <div class="input-group flex-nowrap">
                                    ...
                                    <input type="text" class="form-control text-size cars number-only" name="nilai_pembiayaan" value="<?= $data->nilai_pembiayaan ?>" id="nilai_pembiayaan" data-type="currency" placeholder="Nilai Pengajuan Pembiayaan" aria-label="Username" aria-describedby="addon-wrapping">
                                </div>
                            </div>
                            <div class="form-group ml-3 mr-3">
                                <label>Informasi Tambahan</label>
                                <textarea class="form-control text-size cars" name="informasi_tambahan" id="informasi_tambahan" cols="30" rows="10" placeholder="isi jika anda informasi tambahan" style="height:110px;"><?= $data->informasi_tambahan ?></textarea>
                            </div>
                    ...
                    <div class="tab-pane p-3" id="lampiran" role="tabpanel">
                        <div class="row">
                                            ...
                                            ?>
                                                <?php if (get_extension($upload)) { ?>
                                                    <div class="zoom-gallery">
                                                        <a href="<?= base_url('uploads/my_cars/' . $upload) ?>"><img src="<?= base_url('uploads/my_cars/' . $upload) ?>" alt="" style="height:150px; width:300px;"></a>
                                                    </div>
                                                <?php } else { ?>
                            ...
                            <div class="col-md-12">
                                <form action="<?= base_url('ps_my_cars/tambah_lampiran') ?>" method="POST" enctype="multipart/form-data">
                                    <input type="hidden" name="id_my_cars" value="<?= $data->id_my_cars ?>">
                                    <input type="hidden" name="redirect" value="<?= uri_string() ?>">
                                    ...
                                    <div class="inbox-item">
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="inbox-item-author mt-0 mb-1 text-size">
                                                        <b><a href="<?= base_url('zip/my_cars/' . $data->id_my_cars) ?>">Download
