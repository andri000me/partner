                ...
                <div class="tab-content">
                    <div class="tab-pane active p-3" id="partner" role="tabpanel">
                        ...
                        <input type="hidden" name="redirect" value="<?= uri_string() ?>">
                            ...
                            <div class="form-group ml-3 mr-3">
                                ...
                                <input type="text" class="form-control text-size" name="input_produk" id="input_produk" value="My Safar" required readonly />
                            </div>
                            <div class="form-group ml-3 mr-3">
                                <label>Nama Travel</label>
                                <input type="text" class="form-control text-size safar" name="nama_travel" value="<?= $data->nama_travel ?>" id="nama_travel" placeholder="Nama Travel" />
                            </div>
                    ...
                    <div class="tab-pane p-3" id="lampiran" role="tabpanel">
                        <div class="row">
                                            ...
                                            ?>
                                                <?php if (get_extension($upload)) { ?>
                                                    <div class="zoom-gallery">
                                                        <a href="<?= base_url('uploads/my_safar/' . $upload) ?>"><img src="<?= base_url('uploads/my_safar/' . $upload) ?>" alt="" style="height:150px; width:300px;"></a>
                                                    </div>
                                                <?php } else { ?>
                            ...
                            <div class="col-md-12">
                                <form action="<?= base_url('ps_my_safar/tambah_lampiran') ?>" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="inbox-item">
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="inbox-item-author mt-0 mb-1 text-size">
                                                        <b><a href="<?= base_url('zip/my_safar/' . $data->id_my_safar) ?>">Download
