    ...
    <div class="col-lg-8">
        <div class="page-title-box">
            ...
            <ol class="breadcrumb text-size">
                ...
                <li class="breadcrumb-item active">My Hajat Sewa</li>
            </ol>
        </div>
        <div class="card">
            <div class="card-body">
                ...
                <div class="tab-content">
                    <div class="tab-pane active p-3" id="partner" role="tabpanel">
                        <form class=" text-size" action="<?= base_url('ps_my_hajat_sewa/update') ?>" method="post">
                        <input type="hidden" name="id_my_hajat_sewa" value="<?= $data->id_my_hajat_sewa ?>">
                        ...
                        <input type="hidden" name="redirect" value="<?= uri_string() ?>">
                            ...
                            <div class="form-group ml-3 mr-3">
                                ...
                                <select class="form-control text-size hajat" name="kategori_myhajat" id="kategori_myhajat" disabled>
                                    <option value="">Pilih Kategori My hajat</option>
                                    <option value="Renovasi Rumah">Renovasi Rumah</option>
                                    <option selected value="Sewa bangunan (Rumah / Ruko)">Sewa bangunan
                                        (Rumah / Ruko)
                                    </option>
                                ...
                                <div class="ml-3 mr-3 mt-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control text-size sewa" name="nama_pemilik" value="<?= $data->nama_pemilik ?>" id="nama_pemilik" placeholder="Nama Pemilik" aria-label="Recipient's username" aria-describedby="button-addon2">
                                ...
                                <div class="form-group ml-3 mr-3">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input sewa" type="radio" name="jenis_pemilik" id="jenis_pemilik" <?= $data->jenis_pemilik == 'Perorangan' ? 'checked' : '' ?> value="Perorangan">
                                        <label class="form-check-label">
                                            Perorangan
                                        </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input sewa" type="radio" name="jenis_pemilik" id="jenis_pemilik" <?= $data->jenis_pemilik == 'Badan Usaha' ? 'checked' : '' ?> value="Badan Usaha">
                                        <label class="form-check-label">
                                            Badan Usaha
                                        </label>
                                    </div>
                                ...
                                <div class="form-group ml-3 mr-3">
                                    ...
                                    <input type="text" class="form-control text-size sewa" name="hubungan_pemohon" value="<?= $data->hubungan_pemohon ?>" id="hubungan_pemohon" placeholder="Orang lain / Rekan" />
                                </div>
                                <div class="form-group ml-3 mr-3">
                                    <label>Luas X Panjang</label>
                                    <input type="text" class="form-control text-size sewa" name="luas_panjang" value="<?= $data->luas_panjang ?>" id="luas_panjang" placeholder="Luas X Panjang" />
                                </div>
                                <div class="ml-3 mr-3 mb-3">
                                    ...
                                    <div class="input-group flex-nowrap">
                                        ...
                                        <input type="text" class="form-control text-size number-only sewa" name="biaya_tahunan" value="<?= $data->biaya_tahunan ?>" id="biaya_tahunan" data-type="currency" placeholder="Biaya Sewa Pertahun" aria-label="Username" aria-describedby="addon-wrapping">
                                    </div>
                                </div>
                                <div class="form-group ml-3 mr-3">
                                    <label>Informasi Tambahan</label>
                                    <textarea class="form-control text-size sewa" name="informasi_tambahan" id="informasi_tambahan" cols="30" rows="10" placeholder="isi jika anda informasi tambahan" style="height:110px;"><?= $data->informasi_tambahan ?></textarea>
                                </div>
                            <div class="form-group mb-0 mt-2 float-right btn-maintain">
                                <a class="btn btn-info text-size" onclick="return confirm('Apakah Anda yakin MENYETUJUI data tiket ini?')" href="<?= base_url('ps_ticket/approve_status/' . $ticket->id_ps_ticket) ?>">Approve</a>
                                <a class="btn btn-danger text-size" onclick="return confirm('Apakah Anda yakin MENOLAK data tiket ini?')" href="<?= base_url('ps_ticket/reject_status/' . $ticket->id_ps_ticket) ?>">Reject</a>
                    ...
                    <div class="tab-pane p-3" id="lampiran" role="tabpanel">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <form action="<?= base_url('ps_my_hajat_sewa/upload_file') ?>" method="POST" enctype="multipart/form-data">
                                    <input type="hidden" name="id_my_hajat_sewa" value="<?= $data->id_my_hajat_sewa ?>">
                                    <input type="hidden" name="redirect" value="<?= uri_string() ?>">
                                    ...
                                    <div class="inbox-item">
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="inbox-item-author mt-0 mb-1 text-size">
                                                        <b><a href="<?= base_url('zip/my_hajat_sewa/' . $data->id_my_hajat_sewa) ?>">Download
