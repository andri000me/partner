                ...
                <div class="tab-content">
                        ...
                        <form class=" text-size" action="<?= base_url('ps_my_ihram/update') ?>" method="post">
                            ...
                            <div class="form-group ml-3 mr-3">
                                ...
                                <input type="text" class="form-control text-size" name="input_produk" id="input_produk"
                                    value="My Ihram" required readonly />
                            </div>
                            <div class="form-group ml-3 mr-3">
                                <label>Nama Travel</label>
                                <input type="text" class="form-control text-size ihram" name="nama_travel"
                                    value="<?= $data->nama_travel ?>" id="nama_travel" placeholder="Nama Travel" />
                            </div>
                            <div class="form-group ml-3 mr-3">
                                <label>Nomor KTP</label>
                                <input type="text" class="form-control text-size placement ihram number-only"
                                    name="nomor_ktp" value="<?= $data->nomor_ktp ?>" id="nomor_ktp"
                                    placeholder="Nomor KTP" minlength="16" maxlength="16" />
                            </div>
                            <div class="form-group ml-3 mr-3">
                                <label>Nama Paket</label>
                                <input type="text" class="form-control text-size ihram" name="nama_paket"
                                    value="<?= $data->nama_paket ?>" id="nama_paket" placeholder="Nama Paket" />
                            </div>
                            <div class="form-group ml-3 mr-3">
                                <label>Tanggal Keberangkatan</label>
                                <input type="date" class="form-control text-size ihram" name="tanggal_keberangkatan"
                                    value="<?= $data->tanggal_keberangkatan ?>" id="tanggal_keberangkatan" />
                            </div>
                            <div class="form-group ml-3 mr-3">
                                <label>Link Paket</label>
                                <input type="text" class="form-control text-size ihram" name="link_paket"
                                    value="<?= $data->link_paket ?>" id="link_paket" placeholder="Link Paket" />
                            </div>
                    ...
                    <div class="tab-pane p-3" id="lampiran" role="tabpanel">
                        <div class="row">
                                ...
                                <div class="owl-carousel owl-theme">
                                    ...
                                    <div class="item" style="height:150px; width:300px;">
                                        ...
                                        <div class="zoom-gallery">
                                            <a href="<?= base_url('uploads/my_ihram/' . $upload) ?>"><img
                                                    src="<?= base_url('uploads/my_ihram/' . $upload) ?>" alt=""
                            ...
                            <div class="col-md-12">
                                <form action="<?= base_url('ps_my_ihram/tambah_lampiran') ?>" method="POST"
                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="inbox-item-author mt-0 mb-1 text-size">
                                                        <b><a
                                                                href="<?= base_url('zip/my_ihram/' . $data->id_my_ihram) ?>">Download
