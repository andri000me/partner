<div class="row">
    <div class="col-sm-12">
        <div class="page-title-box card-margin-5">
            <h4 class="page-title">Request Product Support</h4>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0);">Help Desk</a></li>
                <li class="breadcrumb-item"><a href="javascript:void(0);">Product Support</a></li>
                <li class="breadcrumb-item active">Request Product Support</li>
            </ol>
        </div>
    </div>
</div>
                ...
                <div class="card m-b-20 crmg">
                    <div class="card-body">
                        ...
                        <div class="form-group ml-3 mr-3">
                            ...
                            <input type="text" class="form-control text-size talim" name="nama_siswa" id="nama_siswa" placeholder="Ryan Issabella" />
                        </div>
                        <div class="form-group ml-3 mr-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="renovasi">
                            ...
                            <div class="form-group ml-3 mr-3">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input renovasi" type="radio" name="jenis_vendor_renovasi" id="jenis_vendor_renovasi" value="Badan Usaha">
                                    <label class="form-check-label">
                                        Badan Usaha
                                    </label>
                                </div>
                            ...
                            <div class="ml-3 mr-3 mb-3">
                                ...
                                <div class="input-group flex-nowrap">
                                    ...
                                    <input type="text" class="form-control text-size number-only renovasi" name="nilai_pengajuan_pembiayaan_renovasi" id="nilai_pengajuan_pembiayaan_renovasi" data-type="currency" placeholder="Nilai Pengajuan Pembiayaan" aria-label="Username" aria-describedby="addon-wrapping">
                                </div>
                            </div>
                            <div class="form-group ml-3 mr-3">
                                <label>Informasi Tambahan</label>
                                <textarea class="form-control text-size renovasi" name="informasi_tambahan_renovasi" id="informasi_tambahan_renovasi" cols="30" rows="10" placeholder="isi jika ada informasi tambahan" style="height:110px;"></textarea>
                            </div>
                        ...
                        <div class="sewa">
                            ...
                            <div class="form-group ml-3 mr-3">
                                ...
                                <input type="text" class="form-control text-size sewa" name="hubungan_pemohon" id="hubungan_pemohon" placeholder="Orang lain / Rekan" />
                            </div>
                            <div class="form-group ml-3 mr-3">
                                <label>Luas X Panjang</label>
                                <input type="text" class="form-control text-size sewa" name="luas_panjang" id="luas_panjang" placeholder="Luas X Panjang" />
                            </div>
                            <div class="ml-3 mr-3 mb-3">
                                ...
                                <div class="input-group flex-nowrap">
                                    ...
                                    <input type="text" class="form-control text-size number-only sewa" name="biaya_tahunan" id="biaya_tahunan" data-type="currency" placeholder="Biaya Sewa Pertahun" aria-label="Username" aria-describedby="addon-wrapping">
                                </div>
                            </div>
                            <div class="form-group ml-3 mr-3">
                                <label>Informasi Tambahan</label>
                                <textarea class="form-control text-size sewa" name="informasi_tambahan_sewa" id="informasi_tambahan" cols="30" rows="10" placeholder="isi jika anda informasi tambahan" style="height:110px;"></textarea>
                            </div>
                        ...
                        <div class="wedding">
                            <div class="ml-3 mr-3 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control text-size wedding" name="nama_wo" id="nama_wo" placeholder="Nama Pemilik" aria-label="Recipient's username" aria-describedby="button-addon2">
                                    <div class="input-group-append">
                                        <button class="btn btn-danger text-size" type="button" id="reset">hapus</button>
                                        <button class="btn btn-primary text-size" type="button" id="button-addon2" data-toggle="modal" data-target=".bd-example-modal-xl">Cari</button>
                                    </div>
                            ...
                            <div class="form-group ml-3 mr-3">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input wedding" type="radio" name="jenis_wo" id="jenis_wo" value="Perorangan">
                                    <label class="form-check-label">
                                        Perorangan
                                    </label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input wedding" type="radio" name="jenis_wo" id="jenis_wo" value="Badan Usaha">
                                    <label class="form-check-label">
                                        Badan Usaha
                                    </label>
                                </div>
                            ...
                            <div class="form-group ml-3 mr-3">
                                ...
                                <input type="text" class="form-control text-size wedding" name="lama_berdiri" id="lama_berdiri" placeholder="Lama Berdiri" />
                            </div>
                            <div class="ml-3 mr-3 mb-3">
                                ...
                                <div class="input-group flex-nowrap">
                                    ...
                                    <input type="text" class="form-control text-size number-only wedding" name="jumlah_biaya" id="jumlah_biaya" data-type="currency" placeholder="jumlah Biaya" aria-label="Username" aria-describedby="addon-wrapping">
                                </div>
                            </div>
                            <div class="form-group ml-3 mr-3">
                                <label>Jumlah Undangan</label>
                                <input type="text" class="form-control text-size wedding" name="jumlah_undangan" id="jumlah_undangan" placeholder="Jumlah Undangan" />
                            </div>
                            <div class="form-group ml-3 mr-3">
                                <label>Akun Sosial Media WO</label>
                                <input type="text" class="form-control text-size wedding" name="sosial_media_wo" id="sosial_media_wo" placeholder="Contoh : ( facebook : syariahbfi | instagram : @syariahbfi )" />
                            </div>
                            <div class="form-group ml-3 mr-3">
                                <label>Informasi Tambahan</label>
                                <textarea class="form-control text-size wedding" name="informasi_tambahan_wo" id="informasi_tambahan" cols="30" rows="10" placeholder="isi jika anda informasi tambahan" style="height:110px;"></textarea>
                            </div>
                        ...
                        <div class="usaha">
                            ...
                            <div class="form-group ml-3 mr-3">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input usaha" type="radio" name="jangka_waktu_franchise" id="jangka_waktu_franchise" value="Selamanya">
                                    <label class="form-check-label">
                                        Selamanya
                                    </label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input usaha" type="radio" name="jangka_waktu_franchise" id="jangka_waktu_franchise" value="Jangka Tertentu">
                                    <label class="form-check-label">
                                        Jangka Tertentu
                                    </label>
                                </div>
                            ...
                            <div class="form-group ml-3 mr-3">
                                ...
                                <input type="text" class="form-control text-size usaha" name="sosial_media_franchise" id="sosial_media_franchise" placeholder="Contoh : ( facebook : syariahbfi | instagram : @syariahbfi )" />
                            </div>
                            <div class="form-group ml-3 mr-3">
                                <label>Informasi Tambahan</label>
                                <textarea class="form-control text-size usaha" name="informasi_tambahan_franchise" id="informasi_tambahan_franchise" cols="30" rows="10" placeholder="isi jika anda informasi tambahan" style="height:110px;"></textarea>
                            </div>
                        ...
                        <div class="lainnya">
                            ...
                            <div class="form-group ml-3 mr-3">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input lainnya" type="radio" name="jenis_penyedia_jasa" id="jenis_penyedia_jasa" value="Perorangan">
                                    <label class="form-check-label">
                                        Perorangan
                                    </label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input lainnya" type="radio" name="jenis_penyedia_jasa" id="jenis_penyedia_jasa" value="Badan Usaha">
                                    <label class="form-check-label">
                                        Badan Usaha
                                    </label>
                                </div>
                            ...
                            <div class="ml-3 mr-3 mb-3">
                                ...
                                <div class="input-group flex-nowrap">
                                    ...
                                    <input type="text" class="form-control text-size number-only lainnya" name="nilai_pengajuan_pembiayaan_lainnya" id="nilai_pengajuan_pembiayaan_lainnya" data-type="currency" placeholder="Nilai Pengajuan Pembiayaan" aria-label="Username" aria-describedby="addon-wrapping">
                                </div>
                            </div>
                            <div class="form-group ml-3 mr-3">
                                <label>Informasi Tambahan</label>
                                <textarea class="form-control text-size lainnya" name="informasi_tambahan_myhajat_lainnya" id="informasi_tambahan" cols="30" rows="10" placeholder="isi jika anda informasi tambahan" style="height:110px;"></textarea>
                            </div>
                ...
                <div class="card m-b-20">
                    <div class="card-body">
                        ...
                        <div class="form-group ml-3 mr-3">
                            ...
                            <input type="text" class="form-control text-size ihram" name="nama_travel_ihram" id="nama_travel_ihram" placeholder="Nama Travel" />
                        </div>
                        <div class="form-group ml-3 mr-3">
                            <label>Nomor KTP</label>
                            <input type="text" class="form-control text-size placement ihram number-only" name="nomor_ktp" id="nomor_ktp" placeholder="Nomor KTP" minlength="16" maxlength="16" />
                        </div>
                        <div class="form-group ml-3 mr-3">
                            <label>Nama Paket</label>
                            <input type="text" class="form-control text-size ihram" name="nama_paket" id="nama_paket" placeholder="Nama Paket" />
                        </div>
                        <div class="form-group ml-3 mr-3">
                            <label>Tanggal Keberangkatan</label>
                            <input type="date" class="form-control text-size ihram" name="tanggal_keberangkatan" id="tanggal_keberangkatan" />
                        </div>
                        <div class="form-group ml-3 mr-3">
                            <label>Link Paket</label>
                            <input type="text" class="form-control text-size ihram" name="link_paket" id="link_paket" placeholder="Link Paket" />
                        </div>
                        <div class="form-group mb-0 float-right mt-3 mr-3 web">
                            <!-- <a href="#"
            ...
            <div class="safar">
                <div class="card m-b-20">
                    <div class="card-body">
                        ...
                        <div class="form-group ml-3 mr-3">
                            <label>Nama Travel</label>
                            <input type="text" class="form-control text-size safar" name="nama_travel_safar" id="nama_travel_safar" placeholder="Nama Travel" />
                        </div>
                        <div class="form-group mb-0 float-right mt-3 mr-3 web">
                            <!-- <a href="#"
											class="btn btn-secondary waves-effect waves-light text-size">Batal</a> -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="bangunan">
                            <div class="ml-3 mr-3 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control text-size bangunan" name="nama_penyedia_bangunan" id="nama_penyedia_bangunan" placeholder="Nama Vendor" aria-label="Recipient's username" aria-describedby="button-addon2">
                                    <div class="input-group-append">
                                        <button class="btn btn-danger text-size" type="button" id="reset">hapus</button>
                                        <button class="btn btn-primary text-size" type="button" id="button-addon2" data-toggle="modal" data-target=".bd-example-modal-xl">Cari</button>
                                    </div>
                            ...
                            <div class="form-group ml-3 mr-3">
                                ...
                                <select class="form-control text-size bangunan" name="jenis_penyedia_bangunan" id="jenis_penyedia_bangunan">
                            ...
                            <div class="form-group ml-3 mr-3">
                                ...
                                <div class="form-check form-check-inline mt-2">
                                    <input class="form-check-input bangunan" type="radio" name="tujuan_pembelian_bangunan" id="tujuan_pembelian_bangunan" value="Konsumtif">
                                    <label class="form-check-label">
                                        Konsumtif
                                    </label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input bangunan" type="radio" name="tujuan_pembelian_bangunan" id="tujuan_pembelian_bangunan" value="Produktif">
                                    <label class="form-check-label">
                                        Produktif
                                    </label>
                                </div>
                            ...
                            <div class="form-group ml-3 mr-3">
                                ...
                                <input type="text" class="form-control text-size bangunan" name="lokasi_pembangunan" id="lokasi_pembangunan" placeholder="Lokasi Yang Akan Dibangun / Direnovasi" />
                            </div>
                            <div class="form-group ml-3 mr-3">
                                <label>Estimasi Waktu Pelaksanaan</label>
                                <input type="text" class="form-control text-size bangunan" name="estimasi_pembangunan" id="estimasi_pembangunan" placeholder="Estimasi Waktu Pelaksanaan" />
                            </div>
                            <div class="ml-3 mr-3 mb-3">
                                <label>Nilai Pengajuan Pembiayaan</label>
                                <div class="input-group flex-nowrap">
                                    ...
                                    <input type="text" class="form-control text-size number-only bangunan" name="nilai_pengajuan_pembiayaan" id="nilai_pembiayaan_bangunan" data-type="currency" placeholder="Nilai Pengajuan Pembiayaan" aria-label="Username" aria-describedby="addon-wrapping">
                                </div>
                            </div>
                            <div class="form-group ml-3 mr-3">
                                <label>Informasi Tambahan</label>
                                <textarea class="form-control text-size bangunan" name="informasi_tambahan_bangunan" id="informasi_tambahan" cols="30" rows="10" placeholder="isi jika anda informasi tambahan" style="height:110px;"></textarea>
                            </div>
                        ...
                        <div class="elektronik">
                            <div class="ml-3 mr-3 mb-3">
                                <label>Nama Penyedia Barang</label>
                                <div class="input-group">
                                    <input type="text" class="form-control text-size elektronik" name="nama_penyedia_barang" id="nama_penyedia_barang" placeholder="Nama Vendor" aria-label="Recipient's username" aria-describedby="button-addon2">
                                    <div class="input-group-append">
                                        <button class="btn btn-danger text-size" type="button" id="reset">hapus</button>
                                        <button class="btn btn-primary text-size" type="button" id="button-addon2" data-toggle="modal" data-target=".bd-example-modal-xl">Cari</button>
                                    </div>
                            ...
                            <div class="form-group ml-3 mr-3">
                                ...
                                <select class="form-control text-size elektronik" name="jenis_penyedia_barang" id="jenis_penyedia_barang">
                            ...
                            <div class="form-group ml-3 mr-3">
                                <label>Tujuan Pembelian Barang</label><br>
                                <div class="form-check form-check-inline mt-2">
                                    <input class="form-check-input elektronik" type="radio" name="tujuan_pembelian_barang" id="tujuan_pembelian_barang" value="Konsumtif">
                                    <label class="form-check-label">
                                        Konsumtif
                                    </label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input elektronik" type="radio" name="tujuan_pembelian_barang" id="tujuan_pembelian_barang" value="Produktif">
                                    <label class="form-check-label">
                                        Produktif
                                    </label>
                                </div>
                            ...
                            <div class="form-group ml-3 mr-3">
                                ...
                                <input type="text" class="form-control text-size elektronik" name="lama_usaha" id="lama_usaha" placeholder="Lama Usaha" />
                            </div>
                            <div class="form-group ml-3 mr-3">
                                <label>Jenis Barang Elektronik yang akan dibeli</label>
                                <select class="form-control text-size elektronik" name="jenis_barang_elektronik" id="jenis_barang_elektronik">
                                    <option selected value="">Pilih Jenis Penyedia Barang</option>
                            ...
                            <div class="form-group ml-3 mr-3">
                                <input type="text" class="form-control text-size" name="other_jenis_barang_elektronik" id="other_jenis_barang_elektronik" placeholder="Mauskan Jenis Elektronik yang akan dibeli" />
                            </div>
                            <div class="form-group ml-3 mr-3">
                                <label>Jumlah Barang</label>
                                <input type="text" class="form-control text-size elektronik" name="jumlah_barang" id="jumlah_barang" placeholder="Jumlah Barang" />
                            </div>
                            <div class="ml-3 mr-3 mb-3">
                                <label>Nilai Pengajuan Pembiayaan</label>
                                <div class="input-group flex-nowrap">
                                    ...
                                    <input type="text" class="form-control text-size number-only elektronik" name="nilai_pengajuan_pembiayaan" id="nilai_pengajuan_pembiayaan" data-type="currency" placeholder="Nilai Pengajuan Pembiayaan" aria-label="Username" aria-describedby="addon-wrapping">
                                </div>
                            </div>
                            <div class="form-group ml-3 mr-3">
                                <label>Informasi Tambahan</label>
                                <textarea class="form-control text-size elektronik" name="informasi_tambahan" id="informasi_tambahan" cols="30" rows="10" placeholder="isi jika anda informasi tambahan" style="height:110px;"></textarea>
                            </div>
                        ...
                        <div class="barang_modal">
                            <div class="ml-3 mr-3 mb-3">
                                <label>Nama Penyedia Barang</label>
                                <div class="input-group">
                                    <input type="text" class="form-control text-size barang_modal" name="nama_penyedia_modal" id="nama_penyedia_modal" placeholder="Nama Vendor" aria-label="Recipient's username" aria-describedby="button-addon2">
                                    <div class="input-group-append">
                                        <button class="btn btn-danger text-size" type="button" id="reset">hapus</button>
                                        <button class="btn btn-primary text-size" type="button" id="button-addon2" data-toggle="modal" data-target=".bd-example-modal-xl">Cari</button>
                                    </div>
                            ...
                            <div class="form-group ml-3 mr-3">
                                <label>Jenis Penyedia Barang</label>
                                <select class="form-control text-size barang_modal" name="jenis_penyedia_modal" id="jenis_penyedia_modal">
                                    <option selected value="">Pilih Jenis Penyedia Barang</option>
                                    <option value="Toko / AGEN">Toko / AGEN</option>
                                    <option value="Authorized Distributor">Authorized Distributor</option>
                                    <option value="Penjual Perorangan">Penjual Perorangan</option>
                            ...
                            <div class="form-group ml-3 mr-3">
                                ...
                                <input type="text" class="form-control text-size barang_modal" name="jenis_barang_modal" id="jenis_barang_modal" placeholder="Jenis Barang" />
                            </div>
                            <div class="form-group ml-3 mr-3">
                                <label>Tujuan Pembelian Barang</label><br>
                                <div class="form-check form-check-inline mt-2">
                                    <input class="form-check-input barang_modal" type="radio" name="tujuan_pembelian_modal" id="tujuan_pembelian_modal" value="Konsumtif">
                                    <label class="form-check-label">
                                        Konsumtif
                                    </label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input barang_modal" type="radio" name="tujuan_pembelian_modal" id="tujuan_pembelian_modal" value="Produktif">
                                    <label class="form-check-label">
                                        Produktif
                                    </label>
                                </div>
                            ...
                            <div class="ml-3 mr-3 mb-3">
                                ...
                                <div class="input-group flex-nowrap">
                                    ...
                                    <input type="text" class="form-control text-size number-only barang_modal" name="nilai_pembiayaan_modal" id="nilai_pengajuan_pembiayaan" data-type="currency" placeholder="Nilai Pengajuan Pembiayaan" aria-label="Username" aria-describedby="addon-wrapping">
                                </div>
                            </div>
                            <div class="form-group ml-3 mr-3">
                                <label>Informasi Tambahan</label>
                                <textarea class="form-control text-size barang_modal" name="informasi_tambahan_modal" id="informasi_tambahan" cols="30" rows="10" placeholder="isi jika anda informasi tambahan" style="height:110px;"></textarea>
                            </div>
                        ...
                        <div class="qurban">
                            <div class="ml-3 mr-3 mb-3">
                                <label>Nama Penyedia Barang</label>
                                <div class="input-group">
                                    <input type="text" class="form-control text-size qurban" name="nama_penyedia_qurban" id="nama_penyedia_barang" placeholder="Nama Vendor" aria-label="Recipient's username" aria-describedby="button-addon2">
                                    <div class="input-group-append">
                                        <button class="btn btn-danger text-size" type="button" id="reset">hapus</button>
                                        <button class="btn btn-primary text-size" type="button" id="button-addon2" data-toggle="modal" data-target=".bd-example-modal-xl">Cari</button>
                                    </div>
                            ...
                            <div class="form-group ml-3 mr-3">
                                <label>Jenis Penyedia Barang</label>
                                <select class="form-control text-size qurban" name="jenis_penyedia_qurban" id="jenis_penyedia_barang">
                                    <option selected value="">Pilih Jenis Penyedia Barang</option>
                                    <option value="Toko / AGEN">Toko / AGEN</option>
                                    <option value="Authorized Distributor">Authorized Distributor</option>
                                    <option value="Penjual Perorangan">Penjual Perorangan</option>
                            ...
                            <div class="form-group ml-3 mr-3">
                                <label>Lama Usaha</label>
                                <input type="text" class="form-control text-size qurban" name="lama_usaha_qurban" id="lama_usaha_qurban" placeholder="Lama Usaha" />
                            </div>
                            <div class="form-group ml-3 mr-3">
                                <label>Tujuan Pembelian Barang</label><br>
                                <div class="form-check form-check-inline mt-2">
                                    <input class="form-check-input qurban" type="radio" name="tujuan_pembelian_qurban" id="tujuan_pembelian_barang" value="Konsumtif">
                                    <label class="form-check-label">
                                        Konsumtif
                                    </label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input qurban" type="radio" name="tujuan_pembelian_qurban" id="tujuan_pembelian_barang" value="Produktif">
                                    <label class="form-check-label">
                                        Produktif
                                    </label>
                                </div>
                            ...
                            <div class="form-group ml-3 mr-3">
                                ...
                                <input type="text" class="form-control text-size qurban" name="jenis_hewan" id="jenis_hewan" placeholder="Jenis Hewan" />
                            </div>
                            <div class="form-group ml-3 mr-3">
                                <label>Jumlah Hewan</label>
                                <input type="number" class="form-control text-size number_only qurban" name="jumlah_hewan" id="jumlah_hewan" placeholder="Jumlah Hewan" />
                            </div>
                            <div class="ml-3 mr-3 mb-3">
                                <label>Nilai Pengajuan Pembiayaan</label>
                                <div class="input-group flex-nowrap">
                                    ...
                                    <input type="text" class="form-control text-size number-only qurban" name="nilai_pengajuan_pembiayaan" id="nilai_pembiayaan_qurban" data-type="currency" placeholder="Nilai Pengajuan Pembiayaan" aria-label="Username" aria-describedby="addon-wrapping">
                                </div>
                            </div>
                            <div class="form-group ml-3 mr-3">
                                <label>Informasi Tambahan</label>
                                <textarea class="form-control text-size qurban" name="informasi_tambahan_qurban" id="informasi_tambahan" cols="30" rows="10" placeholder="isi jika anda informasi tambahan" style="height:110px;"></textarea>
                            </div>
                        ...
                        <div class="other">
                            <div class="ml-3 mr-3 mb-3">
                                <label>Nama Penyedia Barang</label>
                                <div class="input-group">
                                    <input type="text" class="form-control text-size other" name="nama_penyedia_myfaedah_lainnya" id="nama_penyedia_barang" placeholder="Nama Vendor" aria-label="Recipient's username" aria-describedby="button-addon2">
                                    <div class="input-group-append">
                                        <button class="btn btn-danger text-size" type="button" id="reset">hapus</button>
                                        <button class="btn btn-primary text-size" type="button" id="button-addon2" data-toggle="modal" data-target=".bd-example-modal-xl">Cari</button>
                                    </div>
                            ...
                            <div class="form-group ml-3 mr-3">
                                <label>Jenis Penyedia Barang</label>
                                <select class="form-control text-size other" name="jenis_penyedia_myfaedah_lainnya" id="jenis_penyedia_barang">
                                    <option selected value="">Pilih Jenis Penyedia Barang</option>
                                    <option value="Toko / AGEN">Toko / AGEN</option>
                                    <option value="Authorized Distributor">Authorized Distributor</option>
                                    <option value="Penjual Perorangan">Penjual Perorangan</option>
                            ...
                            <div class="form-group ml-3 mr-3">
                                <label>Tujuan Pembelian Barang</label><br>
                                <div class="form-check form-check-inline mt-2">
                                    <input class="form-check-input other" type="radio" name="tujuan_pembelian_myfaedah_lainnya" id="tujuan_pembelian_barang" value="Konsumtif">
                                    <label class="form-check-label">
                                        Konsumtif
                                    </label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input other" type="radio" name="tujuan_pembelian_myfaedah_lainnya" id="tujuan_pembelian_barang" value="Produktif">
                                    <label class="form-check-label">
                                        Produktif
                                    </label>
                                </div>
                            ...
                            <div class="ml-3 mr-3 mb-3">
                                ...
                                <div class="input-group flex-nowrap">
                                    ...
                                    <input type="text" class="form-control text-size number-only other" name="nilai_pembiayaan_myfaedah_lainnya" id="nilai_pembiayaan_myfaedah_lainnya" data-type="currency" placeholder="Nilai Pengajuan Pembiayaan" aria-label="Username" aria-describedby="addon-wrapping">
                                </div>
                            </div>
                            <div class="form-group ml-3 mr-3">
                                <label>Informasi Tambahan</label>
                                <textarea class="form-control text-size other" name="informasi_tambahan_myfaedah_lainnya" id="informasi_tambahan" cols="30" rows="10" placeholder="isi jika anda informasi tambahan" style="height:110px;"></textarea>
                            </div>
            ...
            <div class="cars">
                <div class="card m-b-20">
                    <div class="card-body">
                        ...
                        <div class="form-group ml-3 mr-3">
                            <label>Nama Penyedia Barang</label>
                            <input type="text" class="form-control text-size cars" name="nama_penyedia_mycars" id="nama_penyedia_mycars" placeholder="Nama Penyedia Barang" />
                        </div>
                        <div class="form-group ml-3 mr-3">
                            <label>Jenis Penyedia Barang</label><br>
                            <div class="form-check form-check-inline mt-2">
                                <input class="form-check-input cars" type="radio" name="jenis_penyedia_mycars" id="jenis_penyedia_mycars" value="Authorized">
                                <label class="form-check-label">
                                    Authorized
                                </label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input cars" type="radio" name="jenis_penyedia_mycars" id="jenis_penyedia_mycars" value="Non_Authorized">
                                <label class="form-check-label">
                                    Non Authorized
                                </label>
                            </div>
                        ...
                        <div class="form-group ml-3 mr-3">
                            ...
                            <div class="form-check form-check-inline mt-2">
                                <input class="form-check-input cars" type="radio" name="kategori_aset" id="kategori_aset" value="New Car">
                                <label class="form-check-label">
                                    New Car
                                </label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input cars" type="radio" name="kategori_aset" id="kategori_aset" value="Used Car">
                                <label class="form-check-label">
                                    Used Car
                                </label>
                            </div>
                        ...
                        <div class="form-group ml-3 mr-3">
                            <label>Lama Usaha</label>
                            <input type="text" class="form-control text-size cars" name="lama_usaha_mycars" id="lama_usaha_mycars" placeholder="Lama Usaha" />
                        </div>
                        <div class="form-group ml-3 mr-3">
                            <label>Kepemilikan Tempat Usaha</label><br>
                            <div class="form-check form-check-inline mt-2">
                                <input class="form-check-input cars" type="radio" name="kepemilikan_tempat" id="kepemilikan_tempat" value="Milik Sendiri">
                                <label class="form-check-label">
                                    Milik Sendiri
                                </label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input cars" type="radio" name="kepemilikan_tempat" id="kepemilikan_tempat" value="Sewa">
                                <label class="form-check-label">
                                    Sewa
                                </label>
                            </div>
                        ...
                        <div class="form-group ml-3 mr-3">
                            ...
                            <input type="number" class="form-control text-size cars number-only" name="jumlah_stok" id="jumlah_stok" placeholder="Jumlah Stok Unit" />
                        </div>
                        <div class="form-group ml-3 mr-3">
                            <label>Tipe Kendaraan</label>
                            <input type="text" class="form-control text-size cars" name="tipe_kendaraan" id="tipe_kendaraan" placeholder="Tipe kendaraan" />
                        </div>
                        <div class="form-group ml-3 mr-3">
                            <label>Tahun</label>
                            <input type="date" class="form-control text-size cars placement" name="tahun" id="tahun" minlength="4" maxlength="4" />
                        </div>
                        <div class="form-group ml-3 mr-3">
                            <label>Warna kendaraan</label>
                            <input type="text" class="form-control text-size cars" name="warna_kendaraan" id="warna_kendaraan" placeholder="Warna kendaraan" />
                        </div>
                        <div class="ml-3 mr-3 mb-3">
                            <label>Nilai Pengajuan Pembiayaan</label>
                            <div class="input-group flex-nowrap">
                                ...
                                <input type="text" class="form-control text-size cars number-only" name="nilai_pembiayaan_mycars" id="nilai_pembiayaan_mycars" data-type="currency" placeholder="Nilai Pengajuan Pembiayaan" aria-label="Username" aria-describedby="addon-wrapping">
                            </div>
                        </div>
                        <div class="form-group ml-3 mr-3">
                            <label>Informasi Tambahan</label>
                            <textarea class="form-control text-size cars" name="informasi_tambahan_mycars" id="informasi_tambahan_mycars" cols="30" rows="10" placeholder="isi jika anda informasi tambahan" style="height:110px;"></textarea>
                        </div>
                        <div class="form-group mb-0 float-right mt-3 mr-3 web">
                            <!-- <a href="#" class="btn btn-secondary waves-effect waves-light text-size">Batal</a> -->
                            <button type="submit" class="btn btn-primary waves-effect waves-light text-size ml-1">
            ...
            <div class="paket">
                <div class="card m-b-20">
                    <div class="card-body">
                        ...
                        <div class="form-group ml-3 mr-3">
                            <label>Nama Travel</label>
                            <input type="text" class="form-control text-size paket" name="nama_travel" id="nama_travel" placeholder="Nama Travel" />
                        </div>
                        <div class="form-group ml-3 mr-3">
                            <label>Produk</label>
