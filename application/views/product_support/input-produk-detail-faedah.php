                    ...
                    <div class="tab-pane active p-3" id="partner" role="tabpanel">
                        <form class=" text-size" action="#" method="post">
                            ...
                            <div class="form-group ml-3 mr-3">
                                ...
                                <input type="text" class="form-control text-size" name="input_produk" id="input_produk" value="My Faedah" required readonly />
                            </div>
                            <!-- <div class="form-group ml-3 mr-3">
                                <label>Input Produk</label>
                            ...
                            <div class="form-group ml-3 mr-3">
                                ...
                                <select class="form-control text-size faedah" name="kategori_myfaedah" id="kategori_myfaedah" required>
                                    ...
                                    <option value="Bahan Matrial bangunan">Bahan Matrial bangunan
                                    </option>
                            ...
                            <div class="bangunan">
                                ...
                                <div class="form-group ml-3 mr-3">
                                    ...
                                    <select class="form-control text-size bangunan" name="jenis_penyedia_bangunan" id="jenis_penyedia_bangunan" required>
                                        <option selected value="">Pilih Jenis Penyedia Bangunan
                                        </option>
                                        <option value="Toko / AGEN">Toko / AGEN</option>
                                        <option value="Authorized Distributor">Authorized
                                            Distributor</option>
                                        <option value="Penjual Perorangan">Penjual Perorangan
                                        </option>
                            ...
                            <div class="elektronik">
                                ...
                                <div class="form-group ml-3 mr-3">
                                    ...
                                    <select class="form-control text-size elektronik" name="jenis_penyedia_barang" id="jenis_penyedia_barang" required>
                                        <option selected value="">Pilih Jenis Penyedia Barang
                                        </option>
                                        <option value="Toko / AGEN">Toko / AGEN</option>
                                        <option value="Authorized Distributor">Authorized
                                            Distributor</option>
