        ...
        <div class="card m-b-20">
            <div class="card-body">
                ...
                <div class="form-group ml-3 mr-3">
                    ...
                    <input type="text" class="form-control text-size ihram" name="nama_travel" id="nama_travel" placeholder="Nama Travel" />
                </div>
                <div class="form-group ml-3 mr-3">
                ...
                <div class="form-group ml-3 mr-3">
                    ...
                    <input type="date" class="form-control text-size ihram" name="tgl_berangkat" id="tgl_berangkat" />
                </div>
                <div class="form-group ml-3 mr-3">
    ...
    <div class="col-lg-7 safar">
        <div class="card m-b-20">
            <div class="card-body">
                ...
                <div class="form-group ml-3 mr-3">
                    <label>Nama Travel</label>
                    <input type="text" class="form-control text-size safar" name="nama_travel" id="nama_travel" placeholder="Nama Travel" />
                </div>
                <div class="form-group mb-0 float-right mt-3 mr-3 web">
                    <!-- <a href="#"
											class="btn btn-secondary waves-effect waves-light text-size">Batal</a> -->
        ...
        <div class="card m-b-20">
            <div class="card-body">
                ...
                <div class="form-group ml-3 mr-3">
                    ...
                    <select class="form-control text-size faedah" name="kategori_myfaedah" id="kategori_myfaedah" required>
                ...
                <div class="bangunan">
                    <div class="ml-3 mr-3 mb-3">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control text-size bangunan" name="nama_penyedia_barang" id="nama_penyedia_barang" placeholder="Nama Vendor" aria-label="Recipient's username" aria-describedby="button-addon2">
                            <div class="input-group-append">
                                <button class="btn btn-danger text-size" type="button" id="reset">hapus</button>
                                <button class="btn btn-primary text-size" type="button" id="button-addon2" data-toggle="modal" data-target=".bd-example-modal-xl">Cari</button>
                            </div>
                    ...
                    <div class="form-group ml-3 mr-3">
                        ...
                        <select class="form-control text-size bangunan" name="jenis_penyedia_bangunan" id="jenis_penyedia_bangunan" required>
                    ...
                    <div class="form-group ml-3 mr-3">
                        ...
                        <div class="form-check form-check-inline mt-2">
                            <input class="form-check-input bangunan" type="radio" name="tujuan_pembelian_barang" id="tujuan_pembelian_barang" value="Konsumtif">
                            <label class="form-check-label">
                                Konsumtif
                            </label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input bangunan" type="radio" name="tujuan_pembelian_barang" id="tujuan_pembelian_barang" value="Produktif">
                            <label class="form-check-label">
                                Produktif
                            </label>
                        </div>
                    ...
                    <div class="form-group ml-3 mr-3">
                        ...
                        <input type="text" class="form-control text-size bangunan" name="lokasi" id="lokasi" placeholder="Lokasi Yang Akan Dibangun / Direnovasi" />
                    </div>
                    <div class="form-group ml-3 mr-3">
                        <label>Estimasi Waktu Pelaksanaan</label>
                        <input type="text" class="form-control text-size bangunan" name="estimasi" id="estimasi" placeholder="Estimasi Waktu Pelaksanaan" />
                    </div>
                    <div class="ml-3 mr-3 mb-3">
                        <label>Nilai Pengajuan Pembiayaan</label>
                        <div class="input-group flex-nowrap">
                            ...
                            <input type="text" class="form-control text-size number-only bangunan" name="nilai_pengajuan_pembiayaan" id="nilai_pengajuan_pembiayaan" data-type="currency" placeholder="Nilai Pengajuan Pembiayaan" aria-label="Username" aria-describedby="addon-wrapping">
                        </div>
                    </div>
                    <div class="form-group ml-3 mr-3">
                        <label>Informasi Tambahan</label>
                        <textarea class="form-control text-size bangunan" name="informasi_tambahan" id="informasi_tambahan" cols="30" rows="10" placeholder="isi jika anda informasi tambahan" style="height:110px;"></textarea>
                    </div>
                ...
                <div class="elektronik">
                    ...
                    <div class="form-group ml-3 mr-3">
                        ...
                        <select class="form-control text-size elektronik" name="jenis_penyedia_barang" id="jenis_penyedia_barang" required>
                    ...
                    <div class="form-group ml-3 mr-3">
                        ...
                        <select class="form-control text-size elektronik" name="jenis_barang_elektronik" id="jenis_barang_elektronik" required>
                            <option selected value="">Pilih Jenis Penyedia Barang</option>
                ...
                <div class="barang_modal">
                    <div class="ml-3 mr-3 mb-3">
                        <label>Nama Penyedia Barang</label>
                        <div class="input-group">
                            <input type="text" class="form-control text-size barang_modal" name="nama_penyedia_barang" id="nama_penyedia_barang" placeholder="Nama Vendor" aria-label="Recipient's username" aria-describedby="button-addon2">
                            <div class="input-group-append">
                                <button class="btn btn-danger text-size" type="button" id="reset">hapus</button>
                                <button class="btn btn-primary text-size" type="button" id="button-addon2" data-toggle="modal" data-target=".bd-example-modal-xl">Cari</button>
                            </div>
                    ...
                    <div class="form-group ml-3 mr-3">
                        <label>Jenis Penyedia Barang</label>
                        <select class="form-control text-size barang_modal" name="jenis_penyedia_barang" id="jenis_penyedia_barang" required>
                            <option selected value="">Pilih Jenis Penyedia Barang</option>
                            <option value="Toko / AGEN">Toko / AGEN</option>
                            <option value="Authorized Distributor">Authorized Distributor</option>
                            <option value="Penjual Perorangan">Penjual Perorangan</option>
                    ...
                    <div class="form-group ml-3 mr-3">
                        ...
                        <input type="text" class="form-control text-size barang_modal" name="jenis_barang" id="jenis_barang" placeholder="Jenis Barang" />
                    </div>
                    <div class="form-group ml-3 mr-3">
                        <label>Tujuan Pembelian Barang</label><br>
                        <div class="form-check form-check-inline mt-2">
                            <input class="form-check-input barang_modal" type="radio" name="tujuan_pembelian_barang" id="tujuan_pembelian_barang" value="Konsumtif">
                            <label class="form-check-label">
                                Konsumtif
                            </label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input barang_modal" type="radio" name="tujuan_pembelian_barang" id="tujuan_pembelian_barang" value="Produktif">
                            <label class="form-check-label">
                                Produktif
                            </label>
                        </div>
                    ...
                    <div class="ml-3 mr-3 mb-3">
                        ...
                        <div class="input-group flex-nowrap">
                            ...
                            <input type="text" class="form-control text-size number-only barang_modal" name="nilai_pengajuan_pembiayaan" id="nilai_pengajuan_pembiayaan" data-type="currency" placeholder="Nilai Pengajuan Pembiayaan" aria-label="Username" aria-describedby="addon-wrapping">
                        </div>
                    </div>
                    <div class="form-group ml-3 mr-3">
                        <label>Informasi Tambahan</label>
                        <textarea class="form-control text-size barang_modal" name="informasi_tambahan" id="informasi_tambahan" cols="30" rows="10" placeholder="isi jika anda informasi tambahan" style="height:110px;"></textarea>
                    </div>
                ...
                <div class="qurban">
                    <div class="ml-3 mr-3 mb-3">
                        <label>Nama Penyedia Barang</label>
                        <div class="input-group">
                            <input type="text" class="form-control text-size qurban" name="nama_penyedia_barang" id="nama_penyedia_barang" placeholder="Nama Vendor" aria-label="Recipient's username" aria-describedby="button-addon2">
                            <div class="input-group-append">
                                <button class="btn btn-danger text-size" type="button" id="reset">hapus</button>
                                <button class="btn btn-primary text-size" type="button" id="button-addon2" data-toggle="modal" data-target=".bd-example-modal-xl">Cari</button>
                            </div>
                    ...
                    <div class="form-group ml-3 mr-3">
                        <label>Jenis Penyedia Barang</label>
                        <select class="form-control text-size qurban" name="jenis_penyedia_barang" id="jenis_penyedia_barang" required>
                            <option selected value="">Pilih Jenis Penyedia Barang</option>
                            <option value="Toko / AGEN">Toko / AGEN</option>
                            <option value="Authorized Distributor">Authorized Distributor</option>
                            <option value="Penjual Perorangan">Penjual Perorangan</option>
                    ...
                    <div class="form-group ml-3 mr-3">
                        <label>Lama Usaha</label>
                        <input type="text" class="form-control text-size qurban" name="lama_usaha" id="lama_usaha" placeholder="Lama Usaha" />
                    </div>
                    <div class="form-group ml-3 mr-3">
                        <label>Tujuan Pembelian Barang</label><br>
                        <div class="form-check form-check-inline mt-2">
                            <input class="form-check-input qurban" type="radio" name="tujuan_pembelian_barang" id="tujuan_pembelian_barang" value="Konsumtif">
                            <label class="form-check-label">
                                Konsumtif
                            </label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input qurban" type="radio" name="tujuan_pembelian_barang" id="tujuan_pembelian_barang" value="Produktif">
                            <label class="form-check-label">
                                Produktif
                            </label>
                        </div>
                    ...
                    <div class="ml-3 mr-3 mb-3">
                        ...
                        <div class="input-group flex-nowrap">
                            ...
                            <input type="text" class="form-control text-size number-only qurban" name="nilai_pengajuan_pembiayaan" id="nilai_pengajuan_pembiayaan" data-type="currency" placeholder="Nilai Pengajuan Pembiayaan" aria-label="Username" aria-describedby="addon-wrapping">
                        </div>
                    </div>
                    <div class="form-group ml-3 mr-3">
                        <label>Informasi Tambahan</label>
                        <textarea class="form-control text-size qurban" name="informasi_tambahan" id="informasi_tambahan" cols="30" rows="10" placeholder="isi jika anda informasi tambahan" style="height:110px;"></textarea>
                    </div>
                ...
                <div class="other">
                    <div class="ml-3 mr-3 mb-3">
                        <label>Nama Penyedia Barang</label>
                        <div class="input-group">
                            <input type="text" class="form-control text-size other" name="nama_penyedia_barang" id="nama_penyedia_barang" placeholder="Nama Vendor" aria-label="Recipient's username" aria-describedby="button-addon2">
                            <div class="input-group-append">
                                <button class="btn btn-danger text-size" type="button" id="reset">hapus</button>
                                <button class="btn btn-primary text-size" type="button" id="button-addon2" data-toggle="modal" data-target=".bd-example-modal-xl">Cari</button>
                            </div>
                    ...
                    <div class="form-group ml-3 mr-3">
                        <label>Jenis Penyedia Barang</label>
                        <select class="form-control text-size other" name="jenis_penyedia_barang" id="jenis_penyedia_barang" required>
                            <option selected value="">Pilih Jenis Penyedia Barang</option>
                            <option value="Toko / AGEN">Toko / AGEN</option>
                            <option value="Authorized Distributor">Authorized Distributor</option>
                            <option value="Penjual Perorangan">Penjual Perorangan</option>
                    ...
                    <div class="form-group ml-3 mr-3">
                        <label>Lama Usaha</label>
                        <input type="text" class="form-control text-size other" name="lama_usaha" id="lama_usaha" placeholder="Lama Usaha" />
                    </div>
                    <div class="form-group ml-3 mr-3">
                        <label>Tujuan Pembelian Barang</label><br>
                        <div class="form-check form-check-inline mt-2">
                            <input class="form-check-input other" type="radio" name="tujuan_pembelian_barang" id="tujuan_pembelian_barang" value="Konsumtif">
                            <label class="form-check-label">
                                Konsumtif
                            </label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input other" type="radio" name="tujuan_pembelian_barang" id="tujuan_pembelian_barang" value="Produktif">
                            <label class="form-check-label">
                                Produktif
                            </label>
                        </div>
                    ...
                    <div class="ml-3 mr-3 mb-3">
                        ...
                        <div class="input-group flex-nowrap">
                            ...
                            <input type="text" class="form-control text-size number-only other" name="nilai_pengajuan_pembiayaan" id="nilai_pengajuan_pembiayaan" data-type="currency" placeholder="Nilai Pengajuan Pembiayaan" aria-label="Username" aria-describedby="addon-wrapping">
                        </div>
                    </div>
                    <div class="form-group ml-3 mr-3">
                        <label>Informasi Tambahan</label>
                        <textarea class="form-control text-size other" name="informasi_tambahan" id="informasi_tambahan" cols="30" rows="10" placeholder="isi jika anda informasi tambahan" style="height:110px;"></textarea>
                    </div>
    ...
    <div class="col-lg-7 cars">
        <div class="card m-b-20">
            <div class="card-body">
                ...
                <div class="form-group ml-3 mr-3">
                    <label>Nama Penyedia Barang</label>
                    <input type="text" class="form-control text-size cars" name="nama_penyedia_barang" id="nama_penyedia_barang" placeholder="Nama Penyedia Barang" />
                </div>
                <div class="form-group ml-3 mr-3">
                    <label>Jenis Penyedia Barang</label><br>
                    <div class="form-check form-check-inline mt-2">
                        <input class="form-check-input cars" type="radio" name="jenis_penyedia_barang" id="jenis_penyedia_barang" value="Authorized">
                        <label class="form-check-label">
                            Authorized
                        </label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input cars" type="radio" name="jenis_penyedia_barang" id="jenis_penyedia_barang" value="Non_Authorized">
                        <label class="form-check-label">
                            Non_Authorized
                        </label>
                    </div>
                ...
                <div class="form-group ml-3 mr-3">
                    ...
                    <select class="form-control text-size cars" name="kategori_penyedia_barang" id="input_produk">
                ...
                <div class="form-group ml-3 mr-3">
                    <label>Lama Usaha</label>
                    <input type="text" class="form-control text-size cars" name="lama_usaha" id="lama_usaha" placeholder="Lama Usaha" />
                </div>
                <div class="form-group ml-3 mr-3">
                    <label>Kepemilikan Tempat Usaha</label><br>
                    <div class="form-check form-check-inline mt-2">
                        <input class="form-check-input cars" type="radio" name="kepemilikan_tempat_usaha" id="kepemilikan_tempat_usaha" value="Milik Sendiri">
                        <label class="form-check-label">
                            Milik Sendiri
                        </label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input cars" type="radio" name="kepemilikan_tempat_usaha" id="kepemilikan_tempat_usaha" value="Sewa">
                        <label class="form-check-label">
                            Sewa
                        </label>
                    </div>
                ...
                <div class="form-group ml-3 mr-3">
                    ...
                    <input type="number" class="form-control text-size cars number-only" name="jumlah_stok_unit" id="jumlah_stok_unit" placeholder="Jumlah Stok Unit" />
                </div>
                <div class="form-group ml-3 mr-3">
                ...
                <div class="ml-3 mr-3 mb-3">
                    ...
                    <div class="input-group flex-nowrap">
                        ...
                        <input type="text" class="form-control text-size cars number-only" name="nilai_pengajuan_pembiayaan" id="nilai_pengajuan_pembiayaan" data-type="currency" placeholder="Nilai Pengajuan Pembiayaan" aria-label="Username" aria-describedby="addon-wrapping">
                    </div>
                </div>
                <div class="form-group ml-3 mr-3">
                    <label>Informasi Tambahan</label>
                    <textarea class="form-control text-size cars" name="informasi_tambahan" id="informasi_tambahan" cols="30" rows="10" placeholder="isi jika anda informasi tambahan" style="height:110px;"></textarea>
                </div>
                <div class="form-group mb-0 float-right mt-3 mr-3 web">
                    <!-- <a href="#" class="btn btn-secondary waves-effect waves-light text-size">Batal</a> -->
                    <button type="submit" class="btn btn-primary waves-effect waves-light text-size ml-1">
    ...
    <div class="col-lg-7 paket">
        <div class="card m-b-20">
            <div class="card-body">
                ...
                <div class="form-group ml-3 mr-3">
                    <label>Produk</label>
                    <select class="form-control text-size paket" name="input_produk" id="input_produk" required>
                        <option selected value="">Pilih Input Produk</option>
                        <option value="My Ta'lim">My Ta'lim</option>
                        <option value="My Safar">My Safar</option>
                        <option value="My Ihram">My Ihram</option>
