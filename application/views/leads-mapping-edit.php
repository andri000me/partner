                            ...
                            <div class="form-row">
                                <div class="col-md-12">
                                    <div class="form-group mr-3 ml-3">
                                        ...
                                        <input type="text" class="form-control <?= form_error('telepon') ? 'is-invalid' : '' ?> placement" onkeypress="return hanyaAngka(event);" name="telepon" id="telepon" value="<?= $data->telepon_mapping ?>" required placeholder="0811977500" maxlength="15" />
                                        <?= form_error('telepon') ?>
                                    </div>
                                </div>
                            </div>
