            ...
            <div class="card-body">
                ...
                <form class="" action="<?= base_url('leads/update_database') ?>" method="post">
                    ...
                    <div class="form-row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group form-margin">
                                ...
                                <input type="text" class="form-control text-size " name="detail_produk"
                                    id="detail_produk" value="<?= $data->detail_produk ?>" required
                            ...
                            <div class="form-group form-margin">
                                ...
                                <select class="form-control text-size" name="activity_marketing" id="activity_marketing"
                                    ...
                                    <option <?=$data->activity_marketing == 'Direct Selling' ? 'selected' : '' ?>
                                    ...
                                    <option <?=$data->activity_marketing == 'Digital Marketing' ? 'selected' : '' ?>
                                    ...
                                    <option <?=$data->activity_marketing == 'Event Promotion' ? 'selected' : '' ?>
                                        value="Event Promotion">Event Promotion</option>
                                    <option <?=$data->activity_marketing == 'Walk In Branch' ? 'selected' : '' ?>
                                        value="Walk In Branch">Walk In Branch</option>
                                    <option <?=$data->activity_marketing == 'Surat Penawaran' ? 'selected' : '' ?>
                                        value="Surat Penawaran">Surat Penawaran</option>
                                    <option <?=$data->activity_marketing == 'Blast WA / SMS' ? 'selected' : '' ?>
                                        value="Blast WA / SMS">Blast WA / SMS</option>
                                    <option <?=$data->activity_marketing == 'Email Marketing' ? 'selected' : '' ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group form-margin event">
                                ...
                                <input type="text" class="form-control text-size" name="nama_event" id="nama_event"
                                    value="<?= $data->nama_event ?>" placeholder="Nama Event">
                            </div>
                            <div class="form-group form-margin nik">
                                <label>NIK</label>
                                <input type="phone" class="form-control text-size placement number-only" name="nik_egc"
                                    id="nik_egc" value="<?= $data->nik_egc ?>" placeholder="072104" minlength="6"
                                    maxlength="7" />
                            </div>
                            <div class="form-group form-margin cabang">
                                <label>Cabang</label>
                                <input type="text" class="form-control text-size" name="cabang_egc" id="cabang_egc"
                                    value="<?= $data->cabang_egc ?>" placeholder="Nama Cabang">
                            </div>
                            <div class="posisi">
                                <div class="form-group form-margin">
                                    <label>Posisi</label>
                                    <input type="text" class="form-control text-size" name="posisi_egc" id="posisi_egc"
                                        value="<?= $data->posisi_egc ?>" placeholder="Nama Jabatan / Posisi">
                                </div>
                            </div>
                            <div class="kontrak-ro">
                                <div class="form-group form-margin">
                                    ...
                                    <input type="phone" class="form-control text-size placement number-only"
                                        ...
                                        placeholder="087883774" minlength="10" maxlength="10" />
                                </div>
                            </div>
                            ...
                            <div class="form-agent form-margin">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control text-size readonly pointer" name="data_agent"
                                        id="nama_agent" value="<?= $data->nama_agent ?>" placeholder=""
                                        aria-label="Recipient's username" aria-describedby="button-addon2">
                                    <div class="input-group-append">
                                        <button class="btn btn-primary btn-data text-size" type="button"
                                            id="btn-data-agent" data-toggle="modal" data-target=""><b>Cari</b></button>
                                    </div>
                                </div>
                            </div>
                            <div class="form form-margin">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control text-size readonly pointer"
                                        name="nama_partner" id="data_partner" value="<?= $data->nama_partner ?>">
                                    <div class="input-group-append">
                                        <button class="btn btn-primary btn-data text-size" type="button" id="btn-data"
                                            data-toggle="modal" data-target=""><b>Cari</b></button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group mb-0 float-right mt-4 form-margin">
                        <a href="<?= base_url('leads/leads_database') ?>"
                            class="btn btn-secondary waves-effect waves-light text-size btn-width"><b>Batal</b></a>
        ...
        <div class="card m-b-20 card-margin-left">
            <div class="card-body">
                ...
                <form class="" action="<?= base_url('Leads_follow_up/save') ?>" method="post">
                    ...
                    <div class="form-group form-margin">
                        <label>Catatan</label>
                        <textarea class="form-control text-size" name="catatan" id="catatan" cols="30" rows="10"
                            required placeholder="Jelaskan detail kegiatan anda" style="height:80px;"></textarea>
                    </div>
                ...
                <table id="" class="datatable-modal table table-hover dt-responsive wrap text-size table-modal"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><button class="btn btn-primary pilih-partner radius"
                                    data-partner="<?= $partner->id_partner ?>"
                                    data-vendor="<?= $partner->nama_usaha ?>">Pilih</button></td>
                        </tr>
                        <?php } ?>
                    </tbody>
                </table>
                ...
                <table id="" class="datatable-modal table table-hover dt-responsive wrap text-size table-modal"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= $agent->telepon ?></td>
                            <td><button class="btn btn-primary pilih-agent radius" data-agent="<?= $agent->id_agent ?>"
                                    data-nama="<?= $agent->nama_lengkap ?>">Pilih</button></td>
                        </tr>
                        <?php } ?>
                    </tbody>
                </table>
