                                ...
                                <div class="form-agent mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control text-size readonly pointer"
                                            name="data_agent" id="data_agent" value="<?= $data->nama_agent ?>"
                ...
                <table id=""
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><button class="btn btn-primary pilih-partner" data-partner="<?= $partner->id_partner ?>"
                ...
                <table id=""
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= $agent->telepon ?></td>
                            <td><button class="btn btn-primary pilih-agent" data-agent="<?= $agent->id_agent ?>"
