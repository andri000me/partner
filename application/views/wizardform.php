                        ...
                        <div id="middle-wizard">
                            ...
                            <div class="step">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control required" id="nama_usaha" name="nama_usaha" value="<?= $data->nama_usaha ?>" placeholder="Nama Usaha">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control required" id="alamat" name="alamat" placeholder="Alamat / Lokasi"><?= $data->alamat ?></textarea>
                                </div>
                                <div class="form-group">
                                    <label>Nomor Telepon</label>
                                    <input type="phone" class="form-control required" id="telepon" name="telepon" value="<?= $data->telepon ?>" placeholder="Nomor Telepon">
                                </div>
                                <div class="form-group">
                                    <label>Email</label>
                                    <input type="email" class="form-control required" id="email" name="email" value="<?= $data->email ?>" placeholder="Email">
                                </div>
                                <div class="form-group">
