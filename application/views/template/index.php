...
<head>
    ...
    <title>Database Partnership - <?= ucfirst(str_replace("_", " ", $this->uri->segment(1))) ?> <?= $this->uri->segment(2) ? ': ' . ucfirst($this->uri->segment(2)) : '' ?></title>
    ...
    <!-- <script src="<?= base_url('https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js') ?>"></!--> -->
