    ...
    <div class=" col-lg-12">
        <div class="card m-b-20">
            <div class="card-body">
                ...
                <table id="" class="datatable-buttons table table-striped table-bordered dt-responsive nowrap text-size" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    <thead>
                        <tr>
                            <th>Nama</th>
                            <th>NIK</th>
