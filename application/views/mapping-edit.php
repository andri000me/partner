    ...
    <div class="col-lg-12">
        <div class="card m-b-20">
            ...
            <div class="card-body">
                ...
                <p class="text-muted m-b-30 text-size">Gunakan form ini untuk mengedit data calon partner yang
                    berpotensi di area cabang anda. Pastikan anda memasukan data yang valid agar memudahkan anda dalam
                    memaintain partner anda.</p>

                <form class="" method="post" action="<?= base_url('partner/update_mapping') ?>"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group ml-3 mr-3">
                                        ...
                                        <input type="text"
                                            ...
                                            name="nama_usaha" id="nama_usaha" value="<?= $data->nama_usaha ?>" required
                                            value="<?= $data->nama_usaha ?>" placeholder="CV Aria Santiika" />
                                ...
                                <div class="col-md-12">
                                    <div class="form-group ml-3 mr-3">
                                        ...
                                        <input type="text"
                                            ...
                                            name="bidang_usaha" id="bidang_usaha" value="<?= $data->bidang_usaha ?>"
                                            required value="<?= $data->bidang_usaha ?>"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group ml-3 mr-3">
                                        ...
                                        <input type="phone"
                                            ...
                                            name="alamat" id="alamat" required value="<?= $data->alamat ?>"
                            ...
                            <div class="form-row">
                                <div class="col-md-12">
                                    <div class="form-group ml-3 mr-3">
                                        ...
                                        <input type="text"
                                            class="form-control placement text-size number-only <?= form_error('telepon') ? 'is-invalid' : '' ?>"
                                    ...
                                    <div class="form-group ml-3 mr-3">
                                        ...
                                        <div>
                                            <input type="email"
                                                ...
                                                name="email" id="email" parsley-type="email" value="<?= $data->email ?>"
                                                value="<?= $data->email ?>" placeholder="Aisha@bfisyariah.id" />
                                            <?= form_error('email'); ?>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group ml-3 mr-3">
                                        ...
                                        <select
                                            ...
                                            <option <?= $data->kategori_produk == 'My Ihram' ? 'selected' : '' ?>
                                                value="My Ihram">My Ihram</option>
                                            <option <?= $data->kategori_produk == 'My Safar' ? 'selected' : '' ?>
                                                value="My Safar">My Safar</option>
                                            <option <?= $data->kategori_produk == 'My Talim' ? 'selected' : '' ?>
                                                value="My Talim">My Talim</option>
                                            <option <?= $data->kategori_produk == 'My Hajat' ? 'selected' : '' ?>
                                                value="My Hajat">My Hajat</option>
                                            <option <?= $data->kategori_produk == 'My Faedah' ? 'selected' : '' ?>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group ml-3 mr-3">
                                        ...
                                        <textarea class="form-control text-size" name="catatan" id="catatan" cols="30"
                                            rows="10" placeholder="isi jika anda informasi tambahan"
                                            style="height:110px;"><?= $data->catatan ?></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-md-12">
                                    <div class="form-group text-size ml-3 mr-3">
                                        ...
                                        <input type="file" name="foto_usaha" class="filestyle text-size"
