								...
								<form class="" method="post" action="<?= base_url('Mapping_partner/save') ?>">
									<div class="form-row">
										<div class="col-md-6 mb-3">
											...
											<div class="input-group ml-3 mr-3">
												<input type="text" class="form-control" name="leads_id" id="leads_id"
													required placeholder="CV Aria Santika"
													aria-label="Recipient's username" aria-describedby="button-addon2">
												<div class="input-group-append mr-4">
													<button class="btn btn-primary" type="button" id="button-addon2"
														data-toggle="modal" data-target=".bd-example-modal-xl"><span
															class="ion-ios7-search-strong"></span></button>
												</div>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group ml-3 mr-3">
												...
												<div>
													<input type="text" class="form-control" name="requester"
														id="requester" parsley-type="requester" required value=""
														placeholder="Requester" readonly />
												</div>
											</div>
										</div>
									</div>
										...
										<div class="col-md-6">
											<div class="form-group ml-3 mr-3">
												...
												<input type="text" class="form-control" name="cabang" id="cabang"
													required value="" placeholder="Cabang" readonly />
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group ml-3 mr-3">
												...
												<input type="text" class="form-control" name="nama" id="nama" required
													value="" placeholder="Nama Konsumen" readonly />
											</div>
										</div>
									</div>
									<div class="form-row">
										<div class="col-md-6">
											<fieldset disabled>
												<div class="form-group ml-3 mr-3">
													...
													<select
														class="form-control <?= form_error('kategori_produk') ? 'is-invalid' : '' ?>"
														name="kategori_produk" id="disabledFieldsetCheck">
									...
									<div class="form-group mb-0 float-right ml-3 mr-3">
										<div>
											...
											<button type="submit"
												class="btn btn-primary waves-effect waves-light text-size ml-1">
												Simpan
											</button>
										</div>
									</div>
								...
								<div class="owl-carousel owl-theme">
									<div class="item">
										<div class="zoom-gallery">
											<a href="../assets/images/ibrahim.jpeg"><img class="item"
													src="../assets/images/ibrahim.jpeg" alt=""></a>
										</div>
									</div>
									<div class="item">
										<div class="zoom-gallery">
													...
													<div class="inbox-item">
														<table class="web">
															<tr>
																...
																<td>
																	<p
																		class="inbox-item-date text-muted mt-1 text-size">
																		30 Des, 2019</p>
																</td>
															</tr>
															<tr>
																...
																<td>
																	<p
																		class="inbox-item-text text-muted mb-0 text-size">
													...
													<div class="inbox-item">
														<table>
															<tr>
																...
																<td>
																	<p
																		class="inbox-item-date text-muted mt-1 mb-0 text-size">
																		30 Des, 2019</p>
																</td>
															</tr>
															<tr>
													...
													<div class="inbox-item">
														<table>
															<tr>
																...
																<td>
																	<p
																		class="inbox-item-author mt-0 mb-1 ml-3 text-size">
																		<b>Kerjasama?</b></p>
																</td>
															</tr>
															<tr>
																		...
																		<div class="form-group ml-3 mb-0">
																			<div class="form-check form-check-inline">
																				<input class="form-check-input"
																					type="radio" name="pernah_promosi"
																					id="pernah_promosi" required
																					value="Ya">
																	...
																	<div class="form-group">
																		<div class="form-check form-check-inline">
																			<input class="form-check-input" type="radio"
																				name="pernah_promosi"
																				id="pernah_promosi" required value="Ya">
														...
														<tr>
															...
															<td>
																<p class="inbox-item-author mt-0 mb-1 text-size"><b><a
																			href="#">Download Semua Lampiran</b></a></p>
															</td>
														</tr>
													</table>
											...
											<div class="box overflow-auto">
												<div class="media">
													<a class="image-popup-vertical-fit"
														href="../assets/images/ibrahim.jpeg" title="Foto Profile.">
														<img class="d-flex align-self-start rounded mr-3" alt=""
															src="../assets/images/ibrahim.jpeg" height="64">
													</a>
