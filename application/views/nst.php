						...
						<div class="form-row">
							<div class="col-md-6 mb-3">
								...
								<div class="input-group ml-3 mr-3">
									<input type="text" class="form-control" name="leads_id" id="leads_id" required placeholder="CV Aria Santika" aria-label="Recipient's username" aria-describedby="button-addon2">
						...
						<div class="form-row">
							...
							<div class="col-md-6">
								<div class="form-group ml-3 mr-3">
									...
									<input type="text" class="form-control" name="nama" id="nama" required value="" placeholder="Nama Konsumen" readonly />
								</div>
							</div>
						</div>
						<div class="form-row">
							<div class="col-md-6">
								<fieldset disabled>
									<div class="form-group ml-3 mr-3">
										...
										<select class="form-control <?= form_error('kategori_produk') ? 'is-invalid' : '' ?>" name="kategori_produk" id="disabledFieldsetCheck">
					...
					<tbody>
						<?php foreach ($leads->result() as $lead) { ?>
							<tr>
								...
								<td><?= $lead->leads_id ?></td>
								<td><button class="btn btn-primary pilih-leads" data-id="<?= $lead->id_leads ?>" data-konsumen="<?= $lead->nama_konsumen ?>" data-leads="<?= $lead->leads_id ?>">Pilih</button></td>
							</tr>
						<?php } ?>
					</tbody>
				</table>
