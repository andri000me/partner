...
class Ps_my_hajat_franchise extends CI_Controller
{
    ...
    public function save()
    {
        ...
        $id = $this->ps_model->create('my_hajat_lainnya', $data);
        ...
        // Activity
        $this->activity('Data My Hajat Lainnya telah dibuat', $id_ps_ticket);
    ...
    public function update()
    {
        ...
        $where = ['id_my_hajat_lainnya' => $post['id_my_hajat_lainnya']];
        $id = $this->ps_model->update('my_hajat_lainnya', $data, $where);
        ...
        $ps_ticket = [
            ...
            // 'created_at'  => date('Y-m-d H:i:s'),
            'updated_at' => date('Y-m-d H:i:s'),
            'id_my_hajat_lainnya'   => $post['id_my_hajat_lainnya'],
        ...
        // Activity
        $this->activity('Data My Hajat Lainnya telah dirubah', $id_ps_ticket);
