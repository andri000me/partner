...
class Fs_konsumen extends CI_Controller
{
    ...
    public function update()
    {
        $data = [
            ...
            'purpose_harga_beli_ke_merchant'    => !empty($this->input->post('purpose_harga_beli_ke_merchant')) ? str_replace(",", "", $this->input->post('purpose_harga_beli_ke_merchant')) : NULL,
            'purpose_harga_jual_ke_konsumen'    => !empty($this->input->post('purpose_harga_jual_ke_konsumen')) ? str_replace(",", "", $this->input->post('purpose_harga_jual_ke_konsumen')) : NULL,
            'purpose_uang_muka'                 => !empty($this->input->post('purpose_uang_muka')) ? str_replace(",", "", $this->input->post('purpose_uang_muka')) : NULL,
            'purpose_biaya_administrasi'        => !empty($this->input->post('purpose_biaya_administrasi')) ? str_replace(",", "", $this->input->post('purpose_biaya_administrasi')) : NULL,
            'purpose_asuransi_jiwa'             => !empty($this->input->post('purpose_asuransi_jiwa')) ? str_replace(",", "", $this->input->post('purpose_asuransi_jiwa')) : NULL,
            'purpose_asuransi_kendaraan'        => !empty($this->input->post('purpose_asuransi_kendaraan')) ? str_replace(",", "", $this->input->post('purpose_asuransi_kendaraan')) : NULL,
            'purpose_total_uang_muka'           => !empty($this->input->post('purpose_total_uang_muka')) ? str_replace(",", "", $this->input->post('purpose_total_uang_muka')) : NULL,
            'purpose_ntf_murni'                 => !empty($this->input->post('purpose_ntf_murni')) ? str_replace(",", "", $this->input->post('purpose_ntf_murni')) : NULL,
            'purpose_lama_angsuran'             => !empty($this->input->post('purpose_lama_angsuran')) ? str_replace(",", "", $this->input->post('purpose_lama_angsuran')) : NULL,
            'purpose_angsuran_per_bulan'        => !empty($this->input->post('purpose_angsuran_per_bulan')) ? str_replace(",", "", $this->input->post('purpose_angsuran_per_bulan')) : NULL,
            'purpose_total_jumlah_tanggungan'   => !empty($this->input->post('purpose_total_jumlah_tanggungan')) ? str_replace(",", "", $this->input->post('purpose_total_jumlah_tanggungan')) : NULL,
            'purpose_nama_merchant_1'           => !empty($this->input->post('purpose_nama_merchant_1')) ? $this->input->post('purpose_nama_merchant_1') : NULL,
            'purpose_harga_1'                   => !empty($this->input->post('purpose_harga_1')) ? str_replace(",", "", $this->input->post('purpose_harga_1')) : NULL,
            ...
            'purpose_harga_2'                   => !empty($this->input->post('purpose_harga_2')) ? str_replace(",", "", $this->input->post('purpose_harga_2')) : NULL,
            ...
            'purpose_harga_3'                   => !empty($this->input->post('purpose_harga_3')) ? str_replace(",", "", $this->input->post('purpose_harga_3')) : NULL,
            ...
            'capacity_karyawan_income_bruto'            => !empty($this->input->post('capacity_karyawan_income_bruto')) ? str_replace(",", "", $this->input->post('capacity_karyawan_income_bruto')) : NULL,
            'capacity_karyawan_income_thp'              => !empty($this->input->post('capacity_karyawan_income_thp')) ? str_replace(",", "", $this->input->post('capacity_karyawan_income_thp')) : NULL,
            ...
            'capacity_karyawan_nilai1'                  => !empty($this->input->post('capacity_karyawan_nilai1')) ? str_replace(",", "", $this->input->post('capacity_karyawan_nilai1')) : NULL,
            ...
            'capacity_karyawan_nilai2'                  => !empty($this->input->post('capacity_karyawan_nilai2')) ? str_replace(",", "", $this->input->post('capacity_karyawan_nilai2')) : NULL,
            ...
            'capacity_karyawan_nilai3'                  => !empty($this->input->post('capacity_karyawan_nilai3')) ? str_replace(",", "", $this->input->post('capacity_karyawan_nilai3')) : NULL,
            'capacity_karyawan_total_bonus'             => !empty($this->input->post('capacity_karyawan_total_bonus')) ? str_replace(",", "", $this->input->post('capacity_karyawan_total_bonus')) : NULL,
            ...
            'capacity_karyawan_nilai_lain1'             => !empty($this->input->post('capacity_karyawan_nilai_lain1')) ? str_replace(",", "", $this->input->post('capacity_karyawan_nilai_lain1')) : NULL,
            ...
            'capacity_karyawan_nilai_lain2'             => !empty($this->input->post('capacity_karyawan_nilai_lain2')) ? str_replace(",", "", $this->input->post('capacity_karyawan_nilai_lain2')) : NULL,
            'capacity_karyawan_total_income_lainnya'    => !empty($this->input->post('capacity_karyawan_total_income_lainnya')) ? str_replace(",", "", $this->input->post('capacity_karyawan_total_income_lainnya')) : NULL,
            'capacity_karyawan_saldo_rekening'          => !empty($this->input->post('capacity_karyawan_saldo_rekening')) ? str_replace(",", "", $this->input->post('capacity_karyawan_saldo_rekening')) : NULL,
            'capacity_karyawan_income_pasangan'         => !empty($this->input->post('capacity_karyawan_income_pasangan')) ? str_replace(",", "", $this->input->post('capacity_karyawan_income_pasangan')) : NULL,
            'capacity_karyawan_total_net_income'        => !empty($this->input->post('capacity_karyawan_total_net_income')) ? str_replace(",", "", $this->input->post('capacity_karyawan_total_net_income')) : NULL,
            'capacity_karyawan_outcome_pendidikan'      => !empty($this->input->post('capacity_karyawan_outcome_pendidikan')) ? str_replace(",", "", $this->input->post('capacity_karyawan_outcome_pendidikan')) : NULL,
            'capacity_karyawan_outcome_rumah'           => !empty($this->input->post('capacity_karyawan_outcome_rumah')) ? str_replace(",", "", $this->input->post('capacity_karyawan_outcome_rumah')) : NULL,
            'capacity_karyawan_outcome_listrik'         => !empty($this->input->post('capacity_karyawan_outcome_listrik')) ? str_replace(",", "", $this->input->post('capacity_karyawan_outcome_listrik')) : NULL,
            'capacity_karyawan_outcome_lainnya'         => !empty($this->input->post('capacity_karyawan_outcome_lainnya')) ? str_replace(",", "", $this->input->post('capacity_karyawan_outcome_lainnya')) : NULL,
            'capacity_karyawan_total_biaya_outcome'     => !empty($this->input->post('capacity_karyawan_total_biaya_outcome')) ? str_replace(",", "", $this->input->post('capacity_karyawan_total_biaya_outcome')) : NULL,
            ...
            'capacity_karyawan_nilai_hutang1'           => !empty($this->input->post('capacity_karyawan_nilai_hutang1')) ? str_replace(",", "", $this->input->post('capacity_karyawan_nilai_hutang1')) : NULL,
            'capacity_karyawan_hutang2'                 => !empty($this->input->post('capacity_karyawan_hutang2')) ? $this->input->post('capacity_karyawan_hutang2') : NULL,
            'capacity_karyawan_nilai_hutang2'           => !empty($this->input->post('capacity_karyawan_nilai_hutang2')) ? str_replace(",", "", $this->input->post('capacity_karyawan_nilai_hutang2')) : NULL,
            'capacity_karyawan_hutang3'                 => !empty($this->input->post('capacity_karyawan_hutang3')) ? $this->input->post('capacity_karyawan_hutang3') : NULL,
            'capacity_karyawan_nilai_hutang3'           => !empty($this->input->post('capacity_karyawan_nilai_hutang3')) ? str_replace(",", "", $this->input->post('capacity_karyawan_nilai_hutang3')) : NULL,
            'capacity_karyawan_total_hutang'            => !empty($this->input->post('capacity_karyawan_total_hutang')) ? str_replace(",", "", $this->input->post('capacity_karyawan_total_hutang')) : NULL,
            'capacity_karyawan_total_outcome'           => !empty($this->input->post('capacity_karyawan_total_outcome')) ? str_replace(",", "", $this->input->post('capacity_karyawan_total_outcome')) : NULL,
            'capacity_karyawan_kelebihan_net_income'    => !empty($this->input->post('capacity_karyawan_kelebihan_net_income')) ? str_replace(",", "", $this->input->post('capacity_karyawan_kelebihan_net_income')) : NULL,
            ...
            'capacity_wir_mutasi1'                  => !empty($this->input->post('capacity_wir_mutasi1')) ? str_replace(",", "", $this->input->post('capacity_wir_mutasi1')) : NULL,
            'capacity_wir_mutasi2'                  => !empty($this->input->post('capacity_wir_mutasi2')) ? str_replace(",", "", $this->input->post('capacity_wir_mutasi2')) : NULL,
            'capacity_wir_mutasi3'                  => !empty($this->input->post('capacity_wir_mutasi3')) ? str_replace(",", "", $this->input->post('capacity_wir_mutasi3')) : NULL,
            'capacity_wir_avr_mutasi'               => !empty($this->input->post('capacity_wir_avr_mutasi')) ? str_replace(",", "", $this->input->post('capacity_wir_avr_mutasi')) : NULL,
            'capacity_wir_nota1'                    => !empty($this->input->post('capacity_wir_nota1')) ? str_replace(",", "", $this->input->post('capacity_wir_nota1')) : NULL,
            'capacity_wir_nota2'                    => !empty($this->input->post('capacity_wir_nota2')) ? str_replace(",", "", $this->input->post('capacity_wir_nota2')) : NULL,
            'capacity_wir_nota3'                    => !empty($this->input->post('capacity_wir_nota3')) ? str_replace(",", "", $this->input->post('capacity_wir_nota3')) : NULL,
            'capacity_wir_avr_nota'                 => !empty($this->input->post('capacity_wir_avr_nota')) ? str_replace(",", "", $this->input->post('capacity_wir_avr_nota')) : NULL,
            'capacity_wir_sewa'                     => !empty($this->input->post('capacity_wir_sewa')) ? str_replace(",", "", $this->input->post('capacity_wir_sewa')) : NULL,
            'capacity_wir_payroll'                  => !empty($this->input->post('capacity_wir_payroll')) ? str_replace(",", "", $this->input->post('capacity_wir_payroll')) : NULL,
            'capacity_wir_internet'                 => !empty($this->input->post('capacity_wir_internet')) ? str_replace(",", "", $this->input->post('capacity_wir_internet')) : NULL,
            'capacity_wir_lainnya'                  => !empty($this->input->post('capacity_wir_lainnya')) ? str_replace(",", "", $this->input->post('capacity_wir_lainnya')) : NULL,
            'capacity_wir_profit_margin'            => !empty($this->input->post('capacity_wir_profit_margin')) ? str_replace(",", "", $this->input->post('capacity_wir_profit_margin')) : NULL,
            'capacity_wir_total_operasional'        => !empty($this->input->post('capacity_wir_total_operasional')) ? str_replace(",", "", $this->input->post('capacity_wir_total_operasional')) : NULL,
            'capacity_wir_total_income'             => !empty($this->input->post('capacity_wir_total_income')) ? str_replace(",", "", $this->input->post('capacity_wir_total_income')) : NULL,
            'capacity_wir_total_net_profit'         => !empty($this->input->post('capacity_wir_total_net_profit')) ? str_replace(",", "", $this->input->post('capacity_wir_total_net_profit')) : NULL,
            ...
            'capacity_wir_nilai_lain1'              => !empty($this->input->post('capacity_wir_nilai_lain1')) ? str_replace(",", "", $this->input->post('capacity_wir_nilai_lain1')) : NULL,
            'capacity_wir_income_lain2'             => !empty($this->input->post('capacity_wir_income_lain2')) ? $this->input->post('capacity_wir_income_lain2') : NULL,
            'capacity_wir_nilai_lain2'              => !empty($this->input->post('capacity_wir_nilai_lain2')) ? str_replace(",", "", $this->input->post('capacity_wir_nilai_lain2')) : NULL,
            'capacity_wir_total_lain'               => !empty($this->input->post('capacity_wir_total_lain')) ? str_replace(",", "", $this->input->post('capacity_wir_total_lain')) : NULL,
            'capacity_wir_saldo_rekening'           => !empty($this->input->post('capacity_wir_saldo_rekening')) ? str_replace(",", "", $this->input->post('capacity_wir_saldo_rekening')) : NULL,
            'capacity_wir_income_pasangan'          => !empty($this->input->post('capacity_wir_income_pasangan')) ? str_replace(",", "", $this->input->post('capacity_wir_income_pasangan')) : NULL,
            'capacity_wir_total_nett_income'        => !empty($this->input->post('capacity_wir_total_nett_income')) ? str_replace(",", "", $this->input->post('capacity_wir_total_nett_income')) : NULL,
            'capacity_wir_outcome_pendidikan'       => !empty($this->input->post('capacity_wir_outcome_pendidikan')) ? str_replace(",", "", $this->input->post('capacity_wir_outcome_pendidikan')) : NULL,
            'capacity_wir_outcome_rumah_tangga'     => !empty($this->input->post('capacity_wir_outcome_rumah_tangga')) ? str_replace(",", "", $this->input->post('capacity_wir_outcome_rumah_tangga')) : NULL,
            'capacity_wir_outcome_internet'         => !empty($this->input->post('capacity_wir_outcome_internet')) ? str_replace(",", "", $this->input->post('capacity_wir_outcome_internet')) : NULL,
            'capacity_wir_outcome_lainnya'          => !empty($this->input->post('capacity_wir_outcome_lainnya')) ? str_replace(",", "", $this->input->post('capacity_wir_outcome_lainnya')) : NULL,
            'capacity_wir_total_biaya_outcome'      => !empty($this->input->post('capacity_wir_total_biaya_outcome')) ? str_replace(",", "", $this->input->post('capacity_wir_total_biaya_outcome')) : NULL,
            ...
            'capacity_wir_nilai_hutang1'            => !empty($this->input->post('capacity_wir_nilai_hutang1')) ? str_replace(",", "", $this->input->post('capacity_wir_nilai_hutang1')) : NULL,
            'capacity_wir_hutang2'                  => !empty($this->input->post('capacity_wir_hutang2')) ? $this->input->post('capacity_wir_hutang2') : NULL,
            'capacity_wir_nilai_hutang2'            => !empty($this->input->post('capacity_wir_nilai_hutang2')) ? str_replace(",", "", $this->input->post('capacity_wir_nilai_hutang2')) : NULL,
            'capacity_wir_hutang3'                  => !empty($this->input->post('capacity_wir_hutang3')) ? $this->input->post('capacity_wir_hutang3') : NULL,
            'capacity_wir_nilai_hutang3'            => !empty($this->input->post('capacity_wir_nilai_hutang3')) ? str_replace(",", "", $this->input->post('capacity_wir_nilai_hutang3')) : NULL,
            'capacity_wir_total_hutang'             => !empty($this->input->post('capacity_wir_total_hutang')) ? str_replace(",", "", $this->input->post('capacity_wir_total_hutang')) : NULL,
            'capacity_wir_total_outcome'            => !empty($this->input->post('capacity_wir_total_outcome')) ? str_replace(",", "", $this->input->post('capacity_wir_total_outcome')) : NULL,
            'capacity_wir_nett_income'              => !empty($this->input->post('capacity_wir_nett_income')) ? str_replace(",", "", $this->input->post('capacity_wir_nett_income')) : NULL,
            ...
            'capacity_wir_usaha_omset_perhari'      => !empty($this->input->post('capacity_wir_usaha_omset_perhari')) ? str_replace(",", "", $this->input->post('capacity_wir_usaha_omset_perhari')) : NULL,
            ...
            'capital_harga1'                => !empty($this->input->post('capital_harga1')) ? str_replace(",", "", $this->input->post('capital_harga1')) : NULL,
            ...
            'capital_harga2'                => !empty($this->input->post('capital_harga2')) ? str_replace(",", "", $this->input->post('capital_harga2')) : NULL,
            ...
            'capital_harga3'                => !empty($this->input->post('capital_harga3')) ? str_replace(",", "", $this->input->post('capital_harga3')) : NULL,
            ...
            'capital_harga4'                => !empty($this->input->post('capital_harga4')) ? str_replace(",", "", $this->input->post('capital_harga4')) : NULL,
            ...
            'capital_harga5'                => !empty($this->input->post('capital_harga5')) ? str_replace(",", "", $this->input->post('capital_harga5')) : NULL,
