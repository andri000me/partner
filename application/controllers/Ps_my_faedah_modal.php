...
class Ps_my_faedah_modal extends CI_Controller
{
    public $where;
    ...
    public function save()
    {
        ...
        $data = [
            ...
            'nilai_pembiayaan'      => str_replace(",", "", $post['nilai_pembiayaan_modal']),
        ...
        $id = $this->ps_model->create('my_faedah_modal', $data);
        ...
        // Activity
        $this->activity('Data My Faedah modal telah dibuat', $id_ps_ticket);
    ...
    public function update()
    {
        ...
        $where = ['id_my_faedah_modal' => $post['id_my_faedah_modal']];
        $id = $this->ps_model->update('my_faedah_modal', $data, $where);
        ...
        $ps_ticket = [
            ...
            // 'created_at'         => date('Y-m-d H:i:s'),
            'updated_at'            => date('Y-m-d H:i:s'),
            'id_my_faedah_modal' => $post['id_my_faedah_modal'],
        ...
        // Activity
        $this->activity('Data My Faedah modal telah dirubah', $id_ps_ticket);
