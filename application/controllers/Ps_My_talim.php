...
class Ps_my_talim extends CI_Controller
{
    public $where;
    ...
    {
        $where = ['ps_my_talim.id_my_talim' => $id];
        $id_ps_ticket = $this->ps_ticket->get($where)->row()->id_ps_ticket;
        $data = [
            'data' => $this->ps_model->get("my_talim", $where)->row(),
        ...
        $this->template->load('template/index', 'product_support/input-produk-detail-talim', $data);
    }
    ...
    public function save()
    {
        ...
        $id = $this->ps_model->create('my_talim', $data);
    ...
    public function update()
    {
        ...
        $where = ['id_my_talim' => $post['id_my_talim']];
        $id = $this->ps_model->update('my_talim', $data, $where);
        ...
        // Activity
        $this->activity('Data My Talim telah dirubah', $post['id_ps_ticket']);
    ...
    public function upload_file()
    {
        ...
        for ($i = 0; $i < $countfiles; $i++) {
            if (!empty($_FILES['tambah_lampiran']['name'][$i])) {
                ...
                //Konfigurasi Upload
                $config['upload_path']         = './uploads/my_talim';
