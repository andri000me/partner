...
class Ps_my_safar extends CI_Controller
{
    public $where;
    ...
    public function save()
    {
        ...
        $id = $this->ps_model->create('my_safar', $data);
        ...
        // Activity
        $this->activity('Data My Safar telah dibuat', $id_ps_ticket);
    ...
    public function update()
    {
        ...
        $where = ['id_my_safar' => $post['id_my_safar']];
        $id = $this->ps_model->update('my_safar', $data, $where);
    ...
    public function upload_file()
    {
        ...
        for ($i = 0; $i < $countfiles; $i++) {
            if (!empty($_FILES['tambah_lampiran']['name'][$i])) {
                ...
                //Konfigurasi Upload
                $config['upload_path']         = './uploads/my_safar';
