...
class Ps_my_ihram extends CI_Controller
{
    public $where;
    ...
    public function save()
    {
        ...
        $data = [
            ...
            'nama_travel'           => $post['nama_travel_ihram'],
        ...
        $id = $this->ps_model->create('my_ihram', $data);
        ...
        // Activity
        $this->activity('Data My Ihram telah dibuat', $id_ps_ticket);
    ...
    public function update()
    {
        ...
        $id = $this->ps_model->update('my_ihram', $data, $where);
    ...
    public function upload_file()
    {
        ...
        for ($i = 0; $i < $countfiles; $i++) {
            if (!empty($_FILES['tambah_lampiran']['name'][$i])) {
                ...
                //Konfigurasi Upload
                $config['upload_path']         = './uploads/my_ihram';
