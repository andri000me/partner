...
class Ps_my_faedah_lainnya extends CI_Controller
{
    public $where;
    ...
    public function save()
    {
        ...
        $data = [
            ...
            'nilai_pembiayaan'      => str_replace(",", "", $post['nilai_pembiayaan_myfaedah_lainnya']),
        ...
        $id = $this->ps_model->create('my_faedah_lainnya', $data);
        ...
        // Activity
        $this->activity('Data My Faedah Lainnya telah dibuat', $id_ps_ticket);
    ...
    public function update()
    {
        ...
        $where = ['id_my_faedah_lainnya' => $post['id_my_faedah_lainnya']];
        $id = $this->ps_model->update('my_faedah_lainnya', $data, $where);
        ...
        $ps_ticket = [
            ...
            // 'created_at'         => date('Y-m-d H:i:s'),
            'updated_at'            => date('Y-m-d H:i:s'),
            'id_my_faedah_lainnya' => $post['id_my_faedah_lainnya'],
        ...
        // Activity
        $this->activity('Data My Faedah Lainnya telah dirubah', $id_ps_ticket);
