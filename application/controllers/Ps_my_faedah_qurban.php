...
class Ps_my_faedah_qurban extends CI_Controller
{
    public $where;
    ...
    public function save()
    {
        ...
        $data = [
            ...
            'jenis_hewan'           => $post['jenis_hewan'],
            'jumlah_hewan'          => $post['jumlah_hewan'],
            'nilai_pembiayaan'      => str_replace(",", "", $post['nilai_pembiayaan_qurban']),
        ...
        $id = $this->ps_model->create('my_faedah_qurban', $data);
        ...
        // Activity
        $this->activity('Data My Faedah Qurban telah dibuat', $id_ps_ticket);
    ...
    public function update()
    {
        ...
        $where = ['id_my_faedah_qurban' => $post['id_my_faedah_qurban']];
        $id = $this->ps_model->update('my_faedah_qurban', $data, $where);
        ...
        $ps_ticket = [
            ...
            // 'created_at'         => date('Y-m-d H:i:s'),
            'updated_at'            => date('Y-m-d H:i:s'),
            'id_my_faedah_qurban' => $post['id_my_faedah_qurban'],
        ...
        // Activity
        $this->activity('Data My Faedah Qurban telah dirubah', $id_ps_ticket);
