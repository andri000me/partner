...
class Ps_my_hajat_franchise extends CI_Controller
{
    ...
    public function save()
    {
        ...
        $data = [
            ...
            'harga_franchise'           => str_replace(",", "", $post['harga_franchise']),
            'jangka_waktu_franchise'    => $post['jangka_waktu_franchise'],
            'sosial_media'              => $post['sosial_media_franchise'],
            ...
            //ID Vendor (mapping)
            'id_mapping'             => $post['id_mapping']
        ];

        $data['upload_file'] = $this->upload_file();

        $id = $this->ps_model->create('my_hajat_franchise', $data);
        ...
        // Activity
        $this->activity('Data My Hajat Franchise telah dibuat', $id_ps_ticket);
    ...
    public function update()
    {
        ...
        $where = ['id_my_hajat_franchise' => $post['id_my_hajat_franchise']];
        $id = $this->ps_model->update('my_hajat_franchise', $data, $where);
        ...
        $ps_ticket = [
            ...
            // 'created_at'  => date('Y-m-d H:i:s'),
            'updated_at' => date('Y-m-d H:i:s'),
            'id_my_hajat_franchise'   => $post['id_my_hajat_franchise'],
        ...
        // Activity
        $this->activity('Data My Hajat Franchise telah dirubah', $id_ps_ticket);
