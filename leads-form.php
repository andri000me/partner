                ...
                <form action="<?= base_url('Leads/save') ?>" method="post" enctype="multipart/form-data" class=" text-size">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-3 nik">
                            <div class="form-group ml-3 mr-3">
                                <label>NIK</label>
                                <input type="phone" class="form-control text-size placement" onkeypress="return hanyaAngka(event);" name="nik_egc" id="nik_egc" required placeholder="0786 6875 8725 3564" maxlength="16" />
                            </div>
                        </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-6 kontrak-cgc">
                            <div class="form-group ml-3 mr-3">
                                ...
                                <input type="phone" class="form-control text-size" onkeypress="return hanyaAngka(event);" name="nomor_kontrak_cgc" id="nomor_kontrak_cgc" required placeholder="087883774"/>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 kontrak-ro">
                            <div class="form-group ml-3 mr-3">
                                <label>Nomor Kontrak</label>
                                <input type="phone" class="form-control text-size" onkeypress="return hanyaAngka(event);" name="nomor_kontrak_ro" id="nomor_kontrak_ro" required placeholder="087883774"/>
                            </div>
                        </div>
